...
emit70: Subscription;
  ...
  graficar(id: number)
  {
    ...
    this.grActual = id;
      ...
      sentencia = "SELECT * FROM (SELECT IFNULL(b.nombre, '" + this.servicio.rTraduccion()[8] + "') AS nombre, '' AS rate_efecto, 'S' AS oee, b.referencia, b.imagen, a.linea, COUNT(a.id) AS tmaquinas, IFNULL(SUM(i.paros), 0) AS paros_m, IFNULL(SUM(i.produccion), 0) AS produccion_m, IFNULL(SUM(i.piezas), 0) AS piezas_m, IFNULL(SUM(i.rechazos), 0) AS rechazos_m, IFNULL(SUM(i.calidad), 0) AS calidad_m, IFNULL(SUM(i.disponible), 0) AS disponible_m, IFNULL(d.reportest, 0) AS reportest, d.reporteid, h.reportefecha, h.reportests, IFNULL(h.narea, '') AS narea, e.tdias_m, IFNULL(SUM(c.totaltiempo), 0) AS tiempo_c_m, SUM(c.totalrep) AS docs_m, SUM(e.lunes * CASE WHEN dismaq.lunes > 0 THEN dismaq.lunes WHEN dislin.lunes > 0 THEN dislin.lunes ELSE disgen.lunes END + e.martes * CASE WHEN dismaq.martes > 0 THEN dismaq.martes WHEN dislin.martes > 0 THEN dislin.martes ELSE disgen.martes END + e.miercoles * CASE WHEN dismaq.miercoles > 0 THEN dismaq.miercoles WHEN dislin.miercoles > 0 THEN dislin.miercoles ELSE disgen.miercoles END + e.jueves * CASE WHEN dismaq.jueves > 0 THEN dismaq.jueves WHEN dislin.jueves > 0 THEN dislin.jueves ELSE disgen.jueves END + e.viernes * CASE WHEN dismaq.viernes > 0 THEN dismaq.viernes WHEN dislin.viernes > 0 THEN dislin.viernes ELSE disgen.viernes END + e.sabado * CASE WHEN dismaq.sabado > 0 THEN dismaq.sabado WHEN dislin.sabado > 0 THEN dislin.sabado ELSE disgen.sabado END + e.domingo * CASE WHEN dismaq.domingo > 0 THEN dismaq.domingo WHEN dislin.domingo > 0 THEN dislin.domingo ELSE disgen.domingo END) AS tdisponible_m, IFNULL(SUM(c.totaltiempo) / 3600 / SUM(c.totalrep), 0) AS mttrc_m, ((SUM(e.lunes * CASE WHEN dismaq.lunes > 0 THEN dismaq.lunes WHEN dislin.lunes > 0 THEN dislin.lunes ELSE disgen.lunes END + e.martes * CASE WHEN dismaq.martes > 0 THEN dismaq.martes WHEN dislin.martes > 0 THEN dislin.martes ELSE disgen.martes END + e.miercoles * CASE WHEN dismaq.miercoles > 0 THEN dismaq.miercoles WHEN dislin.miercoles > 0 THEN dislin.miercoles ELSE disgen.miercoles END + e.jueves * CASE WHEN dismaq.jueves > 0 THEN dismaq.jueves WHEN dislin.jueves > 0 THEN dislin.jueves ELSE disgen.jueves END + e.viernes * CASE WHEN dismaq.viernes > 0 THEN dismaq.viernes WHEN dislin.viernes > 0 THEN dislin.viernes ELSE disgen.viernes END + e.sabado * CASE WHEN dismaq.sabado > 0 THEN dismaq.sabado WHEN dislin.sabado > 0 THEN dislin.sabado ELSE disgen.sabado END + e.domingo * CASE WHEN dismaq.domingo > 0 THEN dismaq.domingo WHEN dislin.domingo > 0 THEN dislin.domingo ELSE disgen.domingo END) - IFNULL(SUM(c.totaltiempo), 0)) / IFNULL(SUM(c.totalrep), 1)) / 3600 AS mtbfc_m FROM " + this.servicio.rBD() + ".cat_maquinas a LEFT JOIN " + this.servicio.rBD() + ".cat_lineas b ON a.linea = b.id LEFT JOIN " + this.servicio.rBD() + ".disponibilidad AS dismaq ON dismaq.maquina = a.id AND dismaq.estatus = 'A' AND dismaq.linea = 0   LEFT JOIN " + this.servicio.rBD() + ".disponibilidad AS dislin ON dislin.linea = a.linea AND dislin.estatus = 'A' AND dislin.maquina = 0 LEFT JOIN (SELECT c.maquina, COUNT(*) AS totalrep, SUM(c.tiemporeparacion + c.tiempollegada) AS totaltiempo FROM " + this.servicio.rBD() + ".reportes c WHERE c.contabilizar = 'S' AND c.estatus >= 100  AND c.fecha_reporte >= '" + this.fDesde + "' AND c.fecha_reporte <= '" + this.fHasta + "' GROUP BY c.maquina) AS c ON a.id = c.maquina LEFT JOIN (SELECT d.linea, COUNT(*) AS reportest, MAX(d.id) AS reporteid FROM " + this.servicio.rBD() + ".reportes d WHERE d.contabilizar = 'S' AND d.estatus <= 10 GROUP BY d.linea) AS d ON a.linea = d.linea LEFT JOIN (SELECT CASE WHEN h.estatus = 0 THEN h.fecha ELSE h.inicio_atencion END reportefecha, h.estatus AS reportests, h.id, g.nombre AS narea FROM " + this.servicio.rBD() + ".reportes h LEFT JOIN " + this.servicio.rBD() + ".cat_areas g ON h.AREA = g.id WHERE h.contabilizar = 'S' AND h.estatus <= 10) AS h ON d.reporteid = h.id LEFT JOIN (SELECT i.equipo, SUM(i.paro) AS paros, SUM(i.produccion_tc) AS produccion, SUM(i.produccion) AS piezas, SUM(i.calidad) AS rechazos, SUM(i.tiempo_disponible) disponible, SUM(i.calidad_tc) AS calidad  FROM " + this.servicio.rBD() + ".lecturas_cortes i WHERE i.id > 0 AND i.dia >= '" + this.fDesde + "' AND i.dia <= '" + this.fHasta + "' GROUP BY i.equipo) AS i ON i.equipo = a.id, (SELECT COUNT(*) AS tdias_m, SUM(CASE WHEN dia = 2 THEN 1 ELSE 0 END) AS lunes, SUM(CASE WHEN dia = 3 THEN 1 ELSE 0 END) AS martes, SUM(CASE WHEN dia = 4 THEN 1 ELSE 0 END) AS miercoles, SUM(CASE WHEN dia = 5 THEN 1 ELSE 0 END) AS jueves, SUM(CASE WHEN dia = 6 THEN 1 ELSE 0 END) AS viernes, SUM(CASE WHEN dia = 7 THEN 1 ELSE 0 END) AS sabado, SUM(CASE WHEN dia = 1 THEN 1 ELSE 0 END) AS domingo FROM " + this.servicio.rBD() + ".dias WHERE  fecha >= '" + this.fDesde + "' AND fecha <= '" + this.fHasta + "' ) AS e, (SELECT * FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND maquina = 0 AND linea = 0) AS disgen GROUP BY b.nombre, b.referencia, b.imagen, a.linea, d.reportest, d.reporteid, h.reportefecha, h.reportests, h.narea, e.tdias_m) AS a LEFT JOIN (SELECT a.linea, IFNULL(SUM(i.paros), 0) AS paros_y, IFNULL(SUM(i.produccion), 0) AS produccion_y, IFNULL(SUM(i.piezas), 0) AS piezas_y, IFNULL(SUM(i.rechazos), 0) AS rechazos_y, IFNULL(SUM(i.calidad), 0) AS calidad_y, IFNULL(SUM(i.disponible), 0) AS disponible_y, e.tdias_y, IFNULL(SUM(c.totaltiempo), 0) AS tiempo_c_y, SUM(c.totalrep) AS docs_y, SUM(e.lunes * CASE WHEN dismaq.lunes > 0 THEN dismaq.lunes WHEN dislin.lunes > 0 THEN dislin.lunes ELSE disgen.lunes END + e.martes * CASE WHEN dismaq.martes > 0 THEN dismaq.martes WHEN dislin.martes > 0 THEN dislin.martes ELSE disgen.martes END + e.miercoles * CASE WHEN dismaq.miercoles > 0 THEN dismaq.miercoles WHEN dislin.miercoles > 0 THEN dislin.miercoles ELSE disgen.miercoles END + e.jueves * CASE WHEN dismaq.jueves > 0 THEN dismaq.jueves WHEN dislin.jueves > 0 THEN dislin.jueves ELSE disgen.jueves END + e.viernes * CASE WHEN dismaq.viernes > 0 THEN dismaq.viernes WHEN dislin.viernes > 0 THEN dislin.viernes ELSE disgen.viernes END + e.sabado * CASE WHEN dismaq.sabado > 0 THEN dismaq.sabado WHEN dislin.sabado > 0 THEN dislin.sabado ELSE disgen.sabado END + e.domingo * CASE WHEN dismaq.domingo > 0 THEN dismaq.domingo WHEN dislin.domingo > 0 THEN dislin.domingo ELSE disgen.domingo END) AS tdisponible_y, IFNULL(SUM(c.totaltiempo) / 3600 / SUM(c.totalrep), 0) AS mttrc_y, ((SUM(e.lunes * CASE WHEN dismaq.lunes > 0 THEN dismaq.lunes WHEN dislin.lunes > 0 THEN dislin.lunes ELSE disgen.lunes END + e.martes * CASE WHEN dismaq.martes > 0 THEN dismaq.martes WHEN dislin.martes > 0 THEN dislin.martes ELSE disgen.martes END + e.miercoles * CASE WHEN dismaq.miercoles > 0 THEN dismaq.miercoles WHEN dislin.miercoles > 0 THEN dislin.miercoles ELSE disgen.miercoles END + e.jueves * CASE WHEN dismaq.jueves > 0 THEN dismaq.jueves WHEN dislin.jueves > 0 THEN dislin.jueves ELSE disgen.jueves END + e.viernes * CASE WHEN dismaq.viernes > 0 THEN dismaq.viernes WHEN dislin.viernes > 0 THEN dislin.viernes ELSE disgen.viernes END + e.sabado * CASE WHEN dismaq.sabado > 0 THEN dismaq.sabado WHEN dislin.sabado > 0 THEN dislin.sabado ELSE disgen.sabado END + e.domingo * CASE WHEN dismaq.domingo > 0 THEN dismaq.domingo WHEN dislin.domingo > 0 THEN dislin.domingo ELSE disgen.domingo END) - IFNULL(SUM(c.totaltiempo), 0)) / IFNULL(SUM(c.totalrep), 1)) / 3600 AS mtbfc_y FROM " + this.servicio.rBD() + ".cat_maquinas a LEFT JOIN " + this.servicio.rBD() + ".cat_lineas b ON a.linea = b.id LEFT JOIN " + this.servicio.rBD() + ".disponibilidad AS dismaq ON dismaq.maquina = a.id AND dismaq.estatus = 'A' AND dismaq.linea = 0   LEFT JOIN " + this.servicio.rBD() + ".disponibilidad AS dislin ON dislin.linea = a.linea AND dislin.estatus = 'A' AND dislin.maquina = 0 LEFT JOIN (SELECT c.maquina, COUNT(*) AS totalrep, SUM(c.tiemporeparacion + c.tiempollegada) AS totaltiempo FROM " + this.servicio.rBD() + ".reportes c WHERE c.contabilizar = 'S' AND c.estatus >= 100  AND c.fecha_reporte >= '" + this.fDesdeY + "' AND c.fecha_reporte <= '" + this.fHastaY + "' GROUP BY c.maquina) AS c ON a.id = c.maquina LEFT JOIN (SELECT maquina, SUM(tiempo) AS tiempo FROM " + this.servicio.rBD() + ".detalleparos f WHERE f.contabilizar = 'S'  AND f.fecha >= '" + this.fDesdeY + "' AND f.fecha <= '" + this.fHastaY + "'  AND f.tipo = 1 GROUP BY maquina) AS f ON c.maquina = f.maquina LEFT JOIN (SELECT i.equipo, SUM(i.paro) AS paros, SUM(i.produccion_tc) AS produccion, SUM(i.produccion) AS piezas, SUM(i.calidad) AS rechazos, SUM(i.tiempo_disponible) disponible, SUM(i.calidad_tc) AS calidad  FROM " + this.servicio.rBD() + ".lecturas_cortes i WHERE i.id > 0 AND i.dia >= '" + this.fDesde + "' AND i.dia <= '" + this.fHasta + "' GROUP BY i.equipo) AS i ON i.equipo = a.id, (SELECT COUNT(*) AS tdias_y, SUM(CASE WHEN dia = 2 THEN 1 ELSE 0 END) AS lunes, SUM(CASE WHEN dia = 3 THEN 1 ELSE 0 END) AS martes, SUM(CASE WHEN dia = 4 THEN 1 ELSE 0 END) AS miercoles, SUM(CASE WHEN dia = 5 THEN 1 ELSE 0 END) AS jueves, SUM(CASE WHEN dia = 6 THEN 1 ELSE 0 END) AS viernes, SUM(CASE WHEN dia = 7 THEN 1 ELSE 0 END) AS sabado, SUM(CASE WHEN dia = 1 THEN 1 ELSE 0 END) AS domingo FROM " + this.servicio.rBD() + ".dias WHERE  fecha >= '" + this.fDesdeY + "' AND fecha <= '" + this.fHastaY + "' ) AS e, (SELECT * FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND maquina = 0 AND linea = 0) AS disgen GROUP BY b.nombre, b.referencia, b.imagen, a.linea, e.tdias_y) AS b ON a.linea = b.linea;"// ORDER BY " + ordenDatos + ";";

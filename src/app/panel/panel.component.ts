...
emit70: Subscription;
  ...
  graficar(id: number)
  {
    ...
    this.grActual = id;
      ...
      this.crearFiltro();
      //sentencia = "SELECT * FROM (SELECT IFNULL(b.nombre, '" + this.servicio.rTraduccion()[8] + "') AS nombre, b.referencia, b.imagen, a.linea, COUNT(a.id) AS tmaquinas, IFNULL(SUM(i.paros), 0) AS paros_m, IFNULL(SUM(i.produccion), 0) AS produccion_m, IFNULL(SUM(i.piezas), 0) AS piezas_m, IFNULL(SUM(i.rechazos), 0) AS rechazos_m, IFNULL(SUM(i.calidad), 0) AS calidad_m, IFNULL(SUM(i.disponible), 0) AS disponible_m, IFNULL(d.reportest, 0) AS reportest, d.reporteid, h.reportefecha, h.reportests, IFNULL(h.narea, '') AS narea, e.tdias_m, IFNULL(SUM(c.totaltiempo), 0) AS tiempo_c_m, SUM(c.totalrep) AS docs_m, SUM(e.lunes * CASE WHEN dismaq.lunes > 0 THEN dismaq.lunes WHEN dislin.lunes > 0 THEN dislin.lunes ELSE disgen.lunes END + e.martes * CASE WHEN dismaq.martes > 0 THEN dismaq.martes WHEN dislin.martes > 0 THEN dislin.martes ELSE disgen.martes END + e.miercoles * CASE WHEN dismaq.miercoles > 0 THEN dismaq.miercoles WHEN dislin.miercoles > 0 THEN dislin.miercoles ELSE disgen.miercoles END + e.jueves * CASE WHEN dismaq.jueves > 0 THEN dismaq.jueves WHEN dislin.jueves > 0 THEN dislin.jueves ELSE disgen.jueves END + e.viernes * CASE WHEN dismaq.viernes > 0 THEN dismaq.viernes WHEN dislin.viernes > 0 THEN dislin.viernes ELSE disgen.viernes END + e.sabado * CASE WHEN dismaq.sabado > 0 THEN dismaq.sabado WHEN dislin.sabado > 0 THEN dislin.sabado ELSE disgen.sabado END + e.domingo * CASE WHEN dismaq.domingo > 0 THEN dismaq.domingo WHEN dislin.domingo > 0 THEN dislin.domingo ELSE disgen.domingo END) AS tdisponible_m, IFNULL(SUM(c.totaltiempo) / 3600 / SUM(c.totalrep), 0) AS mttrc_m, (SUM(e.lunes * CASE WHEN dismaq.lunes > 0 THEN dismaq.lunes WHEN dislin.lunes > 0 THEN dislin.lunes ELSE disgen.lunes END + e.martes * CASE WHEN dismaq.martes > 0 THEN dismaq.martes WHEN dislin.martes > 0 THEN dislin.martes ELSE disgen.martes END + e.miercoles * CASE WHEN dismaq.miercoles > 0 THEN dismaq.miercoles WHEN dislin.miercoles > 0 THEN dislin.miercoles ELSE disgen.miercoles END + e.jueves * CASE WHEN dismaq.jueves > 0 THEN dismaq.jueves WHEN dislin.jueves > 0 THEN dislin.jueves ELSE disgen.jueves END + e.viernes * CASE WHEN dismaq.viernes > 0 THEN dismaq.viernes WHEN dislin.viernes > 0 THEN dislin.viernes ELSE disgen.viernes END + e.sabado * CASE WHEN dismaq.sabado > 0 THEN dismaq.sabado WHEN dislin.sabado > 0 THEN dislin.sabado ELSE disgen.sabado END + e.domingo * CASE WHEN dismaq.domingo > 0 THEN dismaq.domingo WHEN dislin.domingo > 0 THEN dislin.domingo ELSE disgen.domingo END) - IFNULL(f.tiempo, 0) / (IFNULL(SUM(c.totalrep), 0) + 1)) / 3600 AS mtbfc_m FROM " + this.servicio.rBD() + ".cat_maquinas a LEFT JOIN " + this.servicio.rBD() + ".cat_lineas b ON a.linea = b.id LEFT JOIN (SELECT c.maquina, COUNT(*) AS totalrep, SUM(c.tiemporeparacion + c.tiempollegada) AS totaltiempo FROM " + this.servicio.rBD() + ".reportes c WHERE c.contabilizar = 'S' AND c.estatus >= 100  AND c.fecha_reporte >= '" + this.fDesde + "' AND c.fecha_reporte <= '" + this.fHasta + "' GROUP BY c.maquina) AS c ON a.id = c.maquina LEFT JOIN (SELECT d.linea, COUNT(*) AS reportest, MAX(d.id) AS reporteid FROM " + this.servicio.rBD() + ".reportes d WHERE d.contabilizar = 'S' AND d.estatus <= 10 GROUP BY d.linea) AS d ON a.linea = d.linea LEFT JOIN (SELECT CASE WHEN h.estatus = 0 THEN h.fecha ELSE h.inicio_atencion END reportefecha, h.estatus AS reportests, h.id, g.nombre AS narea FROM " + this.servicio.rBD() + ".reportes h LEFT JOIN " + this.servicio.rBD() + ".cat_areas g ON h.AREA = g.id WHERE h.contabilizar = 'S' AND h.estatus <= 10) AS h ON d.reporteid = h.id LEFT JOIN (SELECT i.equipo, SUM(i.paro) AS paros, SUM(i.produccion_tc) AS produccion, SUM(i.produccion) AS piezas, SUM(i.calidad) AS rechazos, SUM(i.tiempo_disponible) disponible, SUM(i.calidad_tc) AS calidad  FROM " + this.servicio.rBD() + ".lecturas_cortes i WHERE i.id > 0 AND i.dia >= '" + this.fDesde + "' AND i.dia <= '" + this.fHasta + "' GROUP BY i.equipo) AS i ON i.equipo = a.id, (SELECT COUNT(*) AS tdias_m, SUM(CASE WHEN dia = 2 THEN 1 ELSE 0 END) AS lunes, SUM(CASE WHEN dia = 3 THEN 1 ELSE 0 END) AS martes, SUM(CASE WHEN dia = 4 THEN 1 ELSE 0 END) AS miercoles, SUM(CASE WHEN dia = 5 THEN 1 ELSE 0 END) AS jueves, SUM(CASE WHEN dia = 6 THEN 1 ELSE 0 END) AS viernes, SUM(CASE WHEN dia = 7 THEN 1 ELSE 0 END) AS sabado, SUM(CASE WHEN dia = 1 THEN 1 ELSE 0 END) AS domingo FROM " + this.servicio.rBD() + ".dias WHERE  fecha >= '" + this.fDesde + "' AND fecha <= '" + this.fHasta + "' ) AS e GROUP BY a.linea, nombre) AS a LEFT JOIN (SELECT a.linea, IFNULL(SUM(i.paros), 0) AS paros_y, IFNULL(SUM(i.produccion), 0) AS produccion_y, IFNULL(SUM(i.piezas), 0) AS piezas_y, IFNULL(SUM(i.rechazos), 0) AS rechazos_y, IFNULL(SUM(i.calidad), 0) AS calidad_y, IFNULL(SUM(i.disponible), 0) AS disponible_y, e.tdias_y, IFNULL(SUM(c.totaltiempo), 0) AS tiempo_c_y, SUM(c.totalrep) AS docs_y, SUM(e.lunes * CASE WHEN dismaq.lunes > 0 THEN dismaq.lunes WHEN dislin.lunes > 0 THEN dislin.lunes ELSE disgen.lunes END + e.martes * CASE WHEN dismaq.martes > 0 THEN dismaq.martes WHEN dislin.martes > 0 THEN dislin.martes ELSE disgen.martes END + e.miercoles * CASE WHEN dismaq.miercoles > 0 THEN dismaq.miercoles WHEN dislin.miercoles > 0 THEN dislin.miercoles ELSE disgen.miercoles END + e.jueves * CASE WHEN dismaq.jueves > 0 THEN dismaq.jueves WHEN dislin.jueves > 0 THEN dislin.jueves ELSE disgen.jueves END + e.viernes * CASE WHEN dismaq.viernes > 0 THEN dismaq.viernes WHEN dislin.viernes > 0 THEN dislin.viernes ELSE disgen.viernes END + e.sabado * CASE WHEN dismaq.sabado > 0 THEN dismaq.sabado WHEN dislin.sabado > 0 THEN dislin.sabado ELSE disgen.sabado END + e.domingo * CASE WHEN dismaq.domingo > 0 THEN dismaq.domingo WHEN dislin.domingo > 0 THEN dislin.domingo ELSE disgen.domingo END) AS tdisponible_y, IFNULL(SUM(c.totaltiempo) / 3600 / SUM(c.totalrep), 0) AS mttrc_y, (SUM(e.lunes * CASE WHEN dismaq.lunes > 0 THEN dismaq.lunes WHEN dislin.lunes > 0 THEN dislin.lunes ELSE disgen.lunes END + e.martes * CASE WHEN dismaq.martes > 0 THEN dismaq.martes WHEN dislin.martes > 0 THEN dislin.martes ELSE disgen.martes END + e.miercoles * CASE WHEN dismaq.miercoles > 0 THEN dismaq.miercoles WHEN dislin.miercoles > 0 THEN dislin.miercoles ELSE disgen.miercoles END + e.jueves * CASE WHEN dismaq.jueves > 0 THEN dismaq.jueves WHEN dislin.jueves > 0 THEN dislin.jueves ELSE disgen.jueves END + e.viernes * CASE WHEN dismaq.viernes > 0 THEN dismaq.viernes WHEN dislin.viernes > 0 THEN dislin.viernes ELSE disgen.viernes END + e.sabado * CASE WHEN dismaq.sabado > 0 THEN dismaq.sabado WHEN dislin.sabado > 0 THEN dislin.sabado ELSE disgen.sabado END + e.domingo * CASE WHEN dismaq.domingo > 0 THEN dismaq.domingo WHEN dislin.domingo > 0 THEN dislin.domingo ELSE disgen.domingo END) - IFNULL(f.tiempo, 0) / (IFNULL(SUM(c.totalrep), 0) + 1)) / 3600 AS mtbfc_y FROM " + this.servicio.rBD() + ".cat_maquinas a LEFT JOIN " + this.servicio.rBD() + ".cat_lineas b ON a.linea = b.id LEFT JOIN (SELECT c.maquina, COUNT(*) AS totalrep, SUM(c.tiemporeparacion + c.tiempollegada) AS totaltiempo FROM " + this.servicio.rBD() + ".reportes c WHERE c.contabilizar = 'S' AND c.estatus >= 100  AND c.fecha_reporte >= '" + this.fDesdeY + "' AND c.fecha_reporte <= '" + this.fHastaY + "' GROUP BY c.maquina) AS c ON a.id = c.maquina LEFT JOIN (SELECT maquina, SUM(tiempo) AS tiempo FROM " + this.servicio.rBD() + ".detalleparos f WHERE f.contabilizar = 'S'  AND f.fecha >= '" + this.fDesdeY + "' AND f.fecha <= '" + this.fHastaY + "'  AND f.tipo = 1 GROUP BY maquina) AS f ON c.maquina = f.maquina LEFT JOIN (SELECT i.equipo, SUM(i.paro) AS paros, SUM(i.produccion_tc) AS produccion, SUM(i.produccion) AS piezas, SUM(i.calidad) AS rechazos, SUM(i.tiempo_disponible) disponible, SUM(i.calidad_tc) AS calidad  FROM " + this.servicio.rBD() + ".lecturas_cortes i WHERE i.id > 0 AND i.dia >= '" + this.fDesde + "' AND i.dia <= '" + this.fHasta + "' GROUP BY i.equipo) AS i ON i.equipo = a.id, (SELECT COUNT(*) AS tdias_y, SUM(CASE WHEN dia = 2 THEN 1 ELSE 0 END) AS lunes, SUM(CASE WHEN dia = 3 THEN 1 ELSE 0 END) AS martes, SUM(CASE WHEN dia = 4 THEN 1 ELSE 0 END) AS miercoles, SUM(CASE WHEN dia = 5 THEN 1 ELSE 0 END) AS jueves, SUM(CASE WHEN dia = 6 THEN 1 ELSE 0 END) AS viernes, SUM(CASE WHEN dia = 7 THEN 1 ELSE 0 END) AS sabado, SUM(CASE WHEN dia = 1 THEN 1 ELSE 0 END) AS domingo FROM " + this.servicio.rBD() + ".dias WHERE  fecha >= '" + this.fDesdeY + "' AND fecha <= '" + this.fHastaY + "' ) AS e GROUP BY a.linea) AS b ON a.linea = b.linea ORDER BY " + ordenDatos + ";";

      sentencia = "SELECT * FROM (SELECT IFNULL(b.nombre, '" + this.servicio.rTraduccion()[8] + "') AS nombre, '' AS rate_efecto, 'S' AS oee, b.referencia, b.imagen, a.linea, COUNT(a.id) AS tmaquinas, IFNULL(SUM(i.paros), 0) AS paros_m, IFNULL(SUM(i.produccion), 0) AS produccion_m, IFNULL(SUM(i.piezas), 0) AS piezas_m, IFNULL(SUM(i.rechazos), 0) AS rechazos_m, IFNULL(SUM(i.calidad), 0) AS calidad_m, IFNULL(SUM(i.disponible), 0) AS disponible_m, IFNULL(d.reportest, 0) AS reportest, d.reporteid, h.reportefecha, h.reportests, IFNULL(h.narea, '') AS narea, e.tdias_m, IFNULL(SUM(c.totaltiempo), 0) AS tiempo_c_m, SUM(c.totalrep) AS docs_m, SUM(e.lunes * CASE WHEN dismaq.lunes > 0 THEN dismaq.lunes WHEN dislin.lunes > 0 THEN dislin.lunes ELSE disgen.lunes END + e.martes * CASE WHEN dismaq.martes > 0 THEN dismaq.martes WHEN dislin.martes > 0 THEN dislin.martes ELSE disgen.martes END + e.miercoles * CASE WHEN dismaq.miercoles > 0 THEN dismaq.miercoles WHEN dislin.miercoles > 0 THEN dislin.miercoles ELSE disgen.miercoles END + e.jueves * CASE WHEN dismaq.jueves > 0 THEN dismaq.jueves WHEN dislin.jueves > 0 THEN dislin.jueves ELSE disgen.jueves END + e.viernes * CASE WHEN dismaq.viernes > 0 THEN dismaq.viernes WHEN dislin.viernes > 0 THEN dislin.viernes ELSE disgen.viernes END + e.sabado * CASE WHEN dismaq.sabado > 0 THEN dismaq.sabado WHEN dislin.sabado > 0 THEN dislin.sabado ELSE disgen.sabado END + e.domingo * CASE WHEN dismaq.domingo > 0 THEN dismaq.domingo WHEN dislin.domingo > 0 THEN dislin.domingo ELSE disgen.domingo END) AS tdisponible_m, IFNULL(SUM(c.totaltiempo) / ~ORM-0002~3600~ORM-0003~ / SUM(c.totalrep), 0) AS mttrc_m, ((SUM(e.lunes * CASE WHEN dismaq.lunes > 0 THEN dismaq.lunes WHEN dislin.lunes > 0 THEN dislin.lunes ELSE disgen.lunes END + e.martes * CASE WHEN dismaq.martes > 0 THEN dismaq.martes WHEN dislin.martes > 0 THEN dislin.martes ELSE disgen.martes END + e.miercoles * CASE WHEN dismaq.miercoles > 0 THEN dismaq.miercoles WHEN dislin.miercoles > 0 THEN dislin.miercoles ELSE disgen.miercoles END + e.jueves * CASE WHEN dismaq.jueves > 0 THEN dismaq.jueves WHEN dislin.jueves > 0 THEN dislin.jueves ELSE disgen.jueves END + e.viernes * CASE WHEN dismaq.viernes > 0 THEN dismaq.viernes WHEN dislin.viernes > 0 THEN dislin.viernes ELSE disgen.viernes END + e.sabado * CASE WHEN dismaq.sabado > 0 THEN dismaq.sabado WHEN dislin.sabado > 0 THEN dislin.sabado ELSE disgen.sabado END + e.domingo * CASE WHEN dismaq.domingo > 0 THEN dismaq.domingo WHEN dislin.domingo > 0 THEN dislin.domingo ELSE disgen.domingo END) - IFNULL(SUM(c.totaltiempo), 0)) / IFNULL(SUM(c.totalrep), 1)) / ~ORM-0002~3600~ORM-0003~ AS mtbfc_m FROM " + this.servicio.rBD() + ".cat_maquinas a LEFT JOIN " + this.servicio.rBD() + ".cat_lineas b ON a.linea = b.id LEFT JOIN " + this.servicio.rBD() + ".disponibilidad AS dismaq ON dismaq.maquina = a.id AND dismaq.estatus = 'A' AND dismaq.linea = 0   LEFT JOIN " + this.servicio.rBD() + ".disponibilidad AS dislin ON dislin.linea = a.linea AND dislin.estatus = 'A' AND dislin.maquina = 0 LEFT JOIN (SELECT c.maquina, COUNT(*) AS totalrep, SUM(c.tiemporeparacion + c.tiempollegada) AS totaltiempo FROM " + this.servicio.rBD() + ".reportes c WHERE c.contabilizar = 'S' AND c.estatus >= 100  AND c.fecha_reporte >= '" + this.fDesde + "' AND c.fecha_reporte <= '" + this.fHasta + "' GROUP BY c.maquina) AS c ON a.id = c.maquina LEFT JOIN (SELECT d.linea, COUNT(*) AS reportest, MAX(d.id) AS reporteid FROM " + this.servicio.rBD() + ".reportes d WHERE d.contabilizar = 'S' AND d.estatus <= 10 GROUP BY d.linea) AS d ON a.linea = d.linea LEFT JOIN (SELECT CASE WHEN h.estatus = 0 THEN h.fecha ELSE h.inicio_atencion END reportefecha, h.estatus AS reportests, h.id, g.nombre AS narea FROM " + this.servicio.rBD() + ".reportes h LEFT JOIN " + this.servicio.rBD() + ".cat_areas g ON h.AREA = g.id WHERE h.contabilizar = 'S' AND h.estatus <= 10) AS h ON d.reporteid = h.id LEFT JOIN (SELECT i.equipo, SUM(i.paro) AS paros, SUM(i.produccion_tc) AS produccion, SUM(i.produccion) AS piezas, SUM(i.calidad) AS rechazos, SUM(i.tiempo_disponible) disponible, SUM(i.calidad_tc) AS calidad  FROM " + this.servicio.rBD() + ".lecturas_cortes i WHERE i.id > 0 AND i.dia >= '" + this.fDesde + "' AND i.dia <= '" + this.fHasta + "' GROUP BY i.equipo) AS i ON i.equipo = a.id, (SELECT COUNT(*) AS tdias_m, SUM(CASE WHEN dia = 2 THEN 1 ELSE 0 END) AS lunes, SUM(CASE WHEN dia = 3 THEN 1 ELSE 0 END) AS martes, SUM(CASE WHEN dia = 4 THEN 1 ELSE 0 END) AS miercoles, SUM(CASE WHEN dia = 5 THEN 1 ELSE 0 END) AS jueves, SUM(CASE WHEN dia = 6 THEN 1 ELSE 0 END) AS viernes, SUM(CASE WHEN dia = 7 THEN 1 ELSE 0 END) AS sabado, SUM(CASE WHEN dia = 1 THEN 1 ELSE 0 END) AS domingo FROM " + this.servicio.rBD() + ".dias WHERE  fecha >= '" + this.fDesde + "' AND fecha <= '" + this.fHasta + "' ) AS e, (SELECT * FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND maquina = 0 AND linea = 0) AS disgen GROUP BY b.nombre, b.referencia, b.imagen, a.linea, d.reportest, d.reporteid, h.reportefecha, h.reportests, h.narea, e.tdias_m) AS a LEFT JOIN (SELECT a.linea, IFNULL(SUM(i.paros), 0) AS paros_y, IFNULL(SUM(i.produccion), 0) AS produccion_y, IFNULL(SUM(i.piezas), 0) AS piezas_y, IFNULL(SUM(i.rechazos), 0) AS rechazos_y, IFNULL(SUM(i.calidad), 0) AS calidad_y, IFNULL(SUM(i.disponible), 0) AS disponible_y, e.tdias_y, IFNULL(SUM(c.totaltiempo), 0) AS tiempo_c_y, SUM(c.totalrep) AS docs_y, SUM(e.lunes * CASE WHEN dismaq.lunes > 0 THEN dismaq.lunes WHEN dislin.lunes > 0 THEN dislin.lunes ELSE disgen.lunes END + e.martes * CASE WHEN dismaq.martes > 0 THEN dismaq.martes WHEN dislin.martes > 0 THEN dislin.martes ELSE disgen.martes END + e.miercoles * CASE WHEN dismaq.miercoles > 0 THEN dismaq.miercoles WHEN dislin.miercoles > 0 THEN dislin.miercoles ELSE disgen.miercoles END + e.jueves * CASE WHEN dismaq.jueves > 0 THEN dismaq.jueves WHEN dislin.jueves > 0 THEN dislin.jueves ELSE disgen.jueves END + e.viernes * CASE WHEN dismaq.viernes > 0 THEN dismaq.viernes WHEN dislin.viernes > 0 THEN dislin.viernes ELSE disgen.viernes END + e.sabado * CASE WHEN dismaq.sabado > 0 THEN dismaq.sabado WHEN dislin.sabado > 0 THEN dislin.sabado ELSE disgen.sabado END + e.domingo * CASE WHEN dismaq.domingo > 0 THEN dismaq.domingo WHEN dislin.domingo > 0 THEN dislin.domingo ELSE disgen.domingo END) AS tdisponible_y, IFNULL(SUM(c.totaltiempo) / ~ORM-0002~3600~ORM-0003~ / SUM(c.totalrep), 0) AS mttrc_y, ((SUM(e.lunes * CASE WHEN dismaq.lunes > 0 THEN dismaq.lunes WHEN dislin.lunes > 0 THEN dislin.lunes ELSE disgen.lunes END + e.martes * CASE WHEN dismaq.martes > 0 THEN dismaq.martes WHEN dislin.martes > 0 THEN dislin.martes ELSE disgen.martes END + e.miercoles * CASE WHEN dismaq.miercoles > 0 THEN dismaq.miercoles WHEN dislin.miercoles > 0 THEN dislin.miercoles ELSE disgen.miercoles END + e.jueves * CASE WHEN dismaq.jueves > 0 THEN dismaq.jueves WHEN dislin.jueves > 0 THEN dislin.jueves ELSE disgen.jueves END + e.viernes * CASE WHEN dismaq.viernes > 0 THEN dismaq.viernes WHEN dislin.viernes > 0 THEN dislin.viernes ELSE disgen.viernes END + e.sabado * CASE WHEN dismaq.sabado > 0 THEN dismaq.sabado WHEN dislin.sabado > 0 THEN dislin.sabado ELSE disgen.sabado END + e.domingo * CASE WHEN dismaq.domingo > 0 THEN dismaq.domingo WHEN dislin.domingo > 0 THEN dislin.domingo ELSE disgen.domingo END) - IFNULL(SUM(c.totaltiempo), 0)) / IFNULL(SUM(c.totalrep), 1)) / ~ORM-0002~3600~ORM-0003~ AS mtbfc_y FROM " + this.servicio.rBD() + ".cat_maquinas a LEFT JOIN " + this.servicio.rBD() + ".cat_lineas b ON a.linea = b.id LEFT JOIN " + this.servicio.rBD() + ".disponibilidad AS dismaq ON dismaq.maquina = a.id AND dismaq.estatus = 'A' AND dismaq.linea = 0   LEFT JOIN " + this.servicio.rBD() + ".disponibilidad AS dislin ON dislin.linea = a.linea AND dislin.estatus = 'A' AND dislin.maquina = 0 LEFT JOIN (SELECT c.maquina, COUNT(*) AS totalrep, SUM(c.tiemporeparacion + c.tiempollegada) AS totaltiempo FROM " + this.servicio.rBD() + ".reportes c WHERE c.contabilizar = 'S' AND c.estatus >= 100  AND c.fecha_reporte >= '" + this.fDesdeY + "' AND c.fecha_reporte <= '" + this.fHastaY + "' GROUP BY c.maquina) AS c ON a.id = c.maquina LEFT JOIN (SELECT maquina, SUM(tiempo) AS tiempo FROM " + this.servicio.rBD() + ".detalleparos f WHERE f.contabilizar = 'S'  AND f.fecha >= '" + this.fDesdeY + "' AND f.fecha <= '" + this.fHastaY + "'  AND f.tipo = 1 GROUP BY maquina) AS f ON c.maquina = f.maquina LEFT JOIN (SELECT i.equipo, SUM(i.paro) AS paros, SUM(i.produccion_tc) AS produccion, SUM(i.produccion) AS piezas, SUM(i.calidad) AS rechazos, SUM(i.tiempo_disponible) disponible, SUM(i.calidad_tc) AS calidad  FROM " + this.servicio.rBD() + ".lecturas_cortes i WHERE i.id > 0 AND i.dia >= '" + this.fDesde + "' AND i.dia <= '" + this.fHasta + "' GROUP BY i.equipo) AS i ON i.equipo = a.id, (SELECT COUNT(*) AS tdias_y, SUM(CASE WHEN dia = 2 THEN 1 ELSE 0 END) AS lunes, SUM(CASE WHEN dia = 3 THEN 1 ELSE 0 END) AS martes, SUM(CASE WHEN dia = 4 THEN 1 ELSE 0 END) AS miercoles, SUM(CASE WHEN dia = 5 THEN 1 ELSE 0 END) AS jueves, SUM(CASE WHEN dia = 6 THEN 1 ELSE 0 END) AS viernes, SUM(CASE WHEN dia = 7 THEN 1 ELSE 0 END) AS sabado, SUM(CASE WHEN dia = 1 THEN 1 ELSE 0 END) AS domingo FROM " + this.servicio.rBD() + ".dias WHERE  fecha >= '" + this.fDesdeY + "' AND fecha <= '" + this.fHastaY + "' ) AS e, (SELECT * FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND maquina = 0 AND linea = 0) AS disgen GROUP BY b.nombre, b.referencia, b.imagen, a.linea, e.tdias_y) AS b ON a.linea = b.linea;"// ORDER BY " + ordenDatos + ";";
      ...
      if (this.grActual == 2)
      {
       ...
       sentencia = "elvisSELECT a.*, b.*, IFNULL(c.rate, 0) AS rate, a.oee_estado_cambio AS tiempoestado, c.rate_efecto, c.ratemed, IFNULL(c.rate_teorico, 0) AS rate_teorico, c.rate_efecto  FROM (SELECT a.id, a.oee, a.oee_estado_cambio, oee_estado, IFNULL(CONCAT(a.nombre , ' / ', b.nombre), '" + this.servicio.rTraduccion()[8] + "') AS nombre, a.referencia, a.imagen, a.linea, IFNULL(b.nombre, '" + this.servicio.rTraduccion()[8] + "') AS nlinea, IFNULL(SUM(i.paros), 0) AS paros_m, IFNULL(SUM(i.produccion), 0) AS produccion_m, IFNULL(SUM(i.piezas), 0) AS piezas_m, IFNULL(SUM(i.rechazos), 0) AS rechazos_m, IFNULL(SUM(i.calidad), 0) AS calidad_m, IFNULL(SUM(i.disponible), 0) AS disponible_m, IFNULL(d.reportest, 0) AS reportest, d.reporteid, h.reportefecha, h.reportests, IFNULL(h.narea, '') AS narea, e.tdias_m, IFNULL(SUM(c.totaltiempo), 0) AS tiempo_c_m, SUM(c.totalrep) AS docs_m, SUM(e.lunes * CASE WHEN dismaq.lunes > 0 THEN dismaq.lunes WHEN dislin.lunes > 0 THEN dislin.lunes ELSE disgen.lunes END + e.martes * CASE WHEN dismaq.martes > 0 THEN dismaq.martes WHEN dislin.martes > 0 THEN dislin.martes ELSE disgen.martes END + e.miercoles * CASE WHEN dismaq.miercoles > 0 THEN dismaq.miercoles WHEN dislin.miercoles > 0 THEN dislin.miercoles ELSE disgen.miercoles END + e.jueves * CASE WHEN dismaq.jueves > 0 THEN dismaq.jueves WHEN dislin.jueves > 0 THEN dislin.jueves ELSE disgen.jueves END + e.viernes * CASE WHEN dismaq.viernes > 0 THEN dismaq.viernes WHEN dislin.viernes > 0 THEN dislin.viernes ELSE disgen.viernes END + e.sabado * CASE WHEN dismaq.sabado > 0 THEN dismaq.sabado WHEN dislin.sabado > 0 THEN dislin.sabado ELSE disgen.sabado END + e.domingo * CASE WHEN dismaq.domingo > 0 THEN dismaq.domingo WHEN dislin.domingo > 0 THEN dislin.domingo ELSE disgen.domingo END) AS tdisponible_m, IFNULL(SUM(c.totaltiempo) / ~ORM-0002~3600~ORM-0003~ / SUM(c.totalrep), 0) AS mttrc_m, ((SUM(e.lunes * CASE WHEN dismaq.lunes > 0 THEN dismaq.lunes WHEN dislin.lunes > 0 THEN dislin.lunes ELSE disgen.lunes END + e.martes * CASE WHEN dismaq.martes > 0 THEN dismaq.martes WHEN dislin.martes > 0 THEN dislin.martes ELSE disgen.martes END + e.miercoles * CASE WHEN dismaq.miercoles > 0 THEN dismaq.miercoles WHEN dislin.miercoles > 0 THEN dislin.miercoles ELSE disgen.miercoles END + e.jueves * CASE WHEN dismaq.jueves > 0 THEN dismaq.jueves WHEN dislin.jueves > 0 THEN dislin.jueves ELSE disgen.jueves END + e.viernes * CASE WHEN dismaq.viernes > 0 THEN dismaq.viernes WHEN dislin.viernes > 0 THEN dislin.viernes ELSE disgen.viernes END + e.sabado * CASE WHEN dismaq.sabado > 0 THEN dismaq.sabado WHEN dislin.sabado > 0 THEN dislin.sabado ELSE disgen.sabado END + e.domingo * CASE WHEN dismaq.domingo > 0 THEN dismaq.domingo WHEN dislin.domingo > 0 THEN dislin.domingo ELSE disgen.domingo END) - IFNULL(SUM(c.totaltiempo), 0)) / IFNULL(SUM(c.totalrep), 1)) / ~ORM-0002~3600~ORM-0003~ AS mtbfc_m FROM " + this.servicio.rBD() + ".cat_maquinas a LEFT JOIN " + this.servicio.rBD() + ".cat_lineas b ON a.linea = b.id LEFT JOIN " + this.servicio.rBD() + ".disponibilidad AS dismaq ON dismaq.maquina = a.id AND dismaq.estatus = 'A' AND dismaq.linea = 0   LEFT JOIN " + this.servicio.rBD() + ".disponibilidad AS dislin ON dislin.linea = a.linea AND dislin.estatus = 'A' AND dislin.maquina = 0 LEFT JOIN (SELECT c.maquina, COUNT(*) AS totalrep, SUM(c.tiemporeparacion + c.tiempollegada) AS totaltiempo FROM " + this.servicio.rBD() + ".reportes c WHERE c.contabilizar = 'S' AND c.estatus >= 100  AND c.fecha_reporte >= '" + this.fDesde + "' AND c.fecha_reporte <= '" + this.fHasta + "' GROUP BY c.maquina) AS c ON a.id = c.maquina LEFT JOIN (SELECT d.maquina, COUNT(*) AS reportest, MAX(d.id) AS reporteid FROM " + this.servicio.rBD() + ".reportes d WHERE d.contabilizar = 'S' AND d.estatus <= 10 GROUP BY d.maquina) AS d ON a.id = d.maquina LEFT JOIN (SELECT CASE WHEN h.estatus = 0 THEN h.fecha ELSE h.inicio_atencion END reportefecha, h.estatus AS reportests, h.id, g.nombre AS narea FROM " + this.servicio.rBD() + ".reportes h LEFT JOIN " + this.servicio.rBD() + ".cat_areas g ON h.AREA = g.id WHERE h.contabilizar = 'S' AND h.estatus <= 10) AS h ON d.reporteid = h.id LEFT JOIN (SELECT i.equipo, SUM(i.paro) AS paros, SUM(i.produccion_tc) AS produccion, SUM(i.produccion) AS piezas, SUM(i.calidad) AS rechazos, SUM(i.tiempo_disponible) disponible, SUM(i.calidad_tc) AS calidad  FROM " + this.servicio.rBD() + ".lecturas_cortes i WHERE i.id > 0 AND i.dia >= '" + this.fDesde + "' AND i.dia <= '" + this.fHasta + "' GROUP BY i.equipo) AS i ON i.equipo = a.id, (SELECT COUNT(*) AS tdias_m, SUM(CASE WHEN dia = 2 THEN 1 ELSE 0 END) AS lunes, SUM(CASE WHEN dia = 3 THEN 1 ELSE 0 END) AS martes, SUM(CASE WHEN dia = 4 THEN 1 ELSE 0 END) AS miercoles, SUM(CASE WHEN dia = 5 THEN 1 ELSE 0 END) AS jueves, SUM(CASE WHEN dia = 6 THEN 1 ELSE 0 END) AS viernes, SUM(CASE WHEN dia = 7 THEN 1 ELSE 0 END) AS sabado, SUM(CASE WHEN dia = 1 THEN 1 ELSE 0 END) AS domingo FROM " + this.servicio.rBD() + ".dias WHERE  fecha >= '" + this.fDesde + "' AND fecha <= '" + this.fHasta + "' ) AS e, (SELECT * FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND maquina = 0 AND linea = 0) AS disgen GROUP BY a.id, a.nombre, a.oee, a.oee_estado_cambio, a.oee_estado, b.nombre, a.referencia, a.imagen, a.linea, d.reportest, d.reporteid, h.reportefecha, h.reportests, h.narea, e.tdias_m) AS a LEFT JOIN (SELECT a.id, IFNULL(SUM(i.paros), 0) AS paros_y, IFNULL(SUM(i.produccion), 0) AS produccion_y, IFNULL(SUM(i.piezas), 0) AS piezas_y, IFNULL(SUM(i.rechazos), 0) AS rechazos_y, IFNULL(SUM(i.calidad), 0) AS calidad_y, IFNULL(SUM(i.disponible), 0) AS disponible_y, e.tdias_y, IFNULL(SUM(c.totaltiempo), 0) AS tiempo_c_y, IFNULL(SUM(c.totalrep), 0) AS docs_y, SUM(e.lunes * CASE WHEN dismaq.lunes > 0 THEN dismaq.lunes WHEN dislin.lunes > 0 THEN dislin.lunes ELSE disgen.lunes END + e.martes * CASE WHEN dismaq.martes > 0 THEN dismaq.martes WHEN dislin.martes > 0 THEN dislin.martes ELSE disgen.martes END + e.miercoles * CASE WHEN dismaq.miercoles > 0 THEN dismaq.miercoles WHEN dislin.miercoles > 0 THEN dislin.miercoles ELSE disgen.miercoles END + e.jueves * CASE WHEN dismaq.jueves > 0 THEN dismaq.jueves WHEN dislin.jueves > 0 THEN dislin.jueves ELSE disgen.jueves END + e.viernes * CASE WHEN dismaq.viernes > 0 THEN dismaq.viernes WHEN dislin.viernes > 0 THEN dislin.viernes ELSE disgen.viernes END + e.sabado * CASE WHEN dismaq.sabado > 0 THEN dismaq.sabado WHEN dislin.sabado > 0 THEN dislin.sabado ELSE disgen.sabado END + e.domingo * CASE WHEN dismaq.domingo > 0 THEN dismaq.domingo WHEN dislin.domingo > 0 THEN dislin.domingo ELSE disgen.domingo END) AS tdisponible_y, IFNULL(SUM(c.totaltiempo) / ~ORM-0002~3600~ORM-0003~ / IFNULL(SUM(c.totalrep), 0), 0) AS mttrc_y, ((SUM(e.lunes * CASE WHEN dismaq.lunes > 0 THEN dismaq.lunes WHEN dislin.lunes > 0 THEN dislin.lunes ELSE disgen.lunes END + e.martes * CASE WHEN dismaq.martes > 0 THEN dismaq.martes WHEN dislin.martes > 0 THEN dislin.martes ELSE disgen.martes END + e.miercoles * CASE WHEN dismaq.miercoles > 0 THEN dismaq.miercoles WHEN dislin.miercoles > 0 THEN dislin.miercoles ELSE disgen.miercoles END + e.jueves * CASE WHEN dismaq.jueves > 0 THEN dismaq.jueves WHEN dislin.jueves > 0 THEN dislin.jueves ELSE disgen.jueves END + e.viernes * CASE WHEN dismaq.viernes > 0 THEN dismaq.viernes WHEN dislin.viernes > 0 THEN dislin.viernes ELSE disgen.viernes END + e.sabado * CASE WHEN dismaq.sabado > 0 THEN dismaq.sabado WHEN dislin.sabado > 0 THEN dislin.sabado ELSE disgen.sabado END + e.domingo * CASE WHEN dismaq.domingo > 0 THEN dismaq.domingo WHEN dislin.domingo > 0 THEN dislin.domingo ELSE disgen.domingo END) - IFNULL(SUM(c.totaltiempo), 0)) / IFNULL(SUM(c.totalrep), 1)) / ~ORM-0002~3600~ORM-0003~ AS mtbfc_y FROM " + this.servicio.rBD() + ".cat_maquinas a LEFT JOIN " + this.servicio.rBD() + ".cat_lineas b ON a.linea = b.id LEFT JOIN " + this.servicio.rBD() + ".disponibilidad AS dismaq ON dismaq.maquina = a.id AND dismaq.estatus = 'A' AND dismaq.linea = 0   LEFT JOIN " + this.servicio.rBD() + ".disponibilidad AS dislin ON dislin.linea = a.linea AND dislin.estatus = 'A' AND dislin.maquina = 0 LEFT JOIN (SELECT c.maquina, COUNT(*) AS totalrep, SUM(c.tiemporeparacion + c.tiempollegada) AS totaltiempo FROM " + this.servicio.rBD() + ".reportes c WHERE c.contabilizar = 'S' AND c.estatus >= 100  AND c.fecha_reporte >= '" + this.fDesdeY + "' AND c.fecha_reporte <= '" + this.fHastaY + "' GROUP BY c.maquina) AS c ON a.id = c.maquina LEFT JOIN (SELECT i.equipo, SUM(i.paro) AS paros, SUM(i.produccion_tc) AS produccion, SUM(i.produccion) AS piezas, SUM(i.calidad) AS rechazos, SUM(i.tiempo_disponible) disponible, SUM(i.calidad_tc) AS calidad  FROM " + this.servicio.rBD() + ".lecturas_cortes i WHERE i.id > 0 AND i.dia >= '" + this.fDesdeY + "' AND i.dia <= '" + this.fHastaY + "' GROUP BY i.equipo) AS i ON i.equipo = a.id, (SELECT COUNT(*) AS tdias_y, SUM(CASE WHEN dia = 2 THEN 1 ELSE 0 END) AS lunes, SUM(CASE WHEN dia = 3 THEN 1 ELSE 0 END) AS martes, SUM(CASE WHEN dia = 4 THEN 1 ELSE 0 END) AS miercoles, SUM(CASE WHEN dia = 5 THEN 1 ELSE 0 END) AS jueves, SUM(CASE WHEN dia = 6 THEN 1 ELSE 0 END) AS viernes, SUM(CASE WHEN dia = 7 THEN 1 ELSE 0 END) AS sabado, SUM(CASE WHEN dia = 1 THEN 1 ELSE 0 END) AS domingo FROM " + this.servicio.rBD() + ".dias WHERE  fecha >= '" + this.fDesdeY + "' AND fecha <= '" + this.fHastaY + "') AS e, (SELECT * FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND maquina = 0 AND linea = 0) AS disgen GROUP BY a.id, a.nombre, e.tdias_y) AS b ON a.id = b.id LEFT JOIN " + this.servicio.rBD() + ".relacion_maquinas_lecturas c ON a.id = c.equipo;"// ORDER BY " + ordenDatos + ";";
      }
      else if (this.grActual == 3)
      {
       ...
       sentencia = "SELECT * FROM (SELECT a.id, a.nombre, a.referencia, e.tdias, 'N' AS oee, '' AS rate_efecto, IFNULL(SUM(c.tiemporeparacion + c.tiempollegada), 0) AS tiempo_c_m, COUNT(c.id) AS docs_m, SUM(e.lunes * CASE WHEN dismaq.lunes > 0 THEN dismaq.lunes WHEN dislin.lunes > 0 THEN dislin.lunes ELSE disgen.lunes END + e.martes * CASE WHEN dismaq.martes > 0 THEN dismaq.martes WHEN dislin.martes > 0 THEN dislin.martes ELSE disgen.martes END + e.miercoles * CASE WHEN dismaq.miercoles > 0 THEN dismaq.miercoles WHEN dislin.miercoles > 0 THEN dislin.miercoles ELSE disgen.miercoles END + e.jueves * CASE WHEN dismaq.jueves > 0 THEN dismaq.jueves WHEN dislin.jueves > 0 THEN dislin.jueves ELSE disgen.jueves END + e.viernes * CASE WHEN dismaq.viernes > 0 THEN dismaq.viernes WHEN dislin.viernes > 0 THEN dislin.viernes ELSE disgen.viernes END + e.sabado * CASE WHEN dismaq.sabado > 0 THEN dismaq.sabado WHEN dislin.sabado > 0 THEN dislin.sabado ELSE disgen.sabado END + e.domingo * CASE WHEN dismaq.domingo > 0 THEN dismaq.domingo WHEN dislin.domingo > 0 THEN dislin.domingo ELSE disgen.domingo END) AS tdisponible_m, IFNULL(SUM(c.tiemporeparacion + c.tiempollegada) / ~ORM-0002~3600~ORM-0003~ / COUNT(c.id), 0) AS mttrc_m, (SUM(e.lunes * CASE WHEN dismaq.lunes > 0 THEN dismaq.lunes WHEN dislin.lunes > 0 THEN dislin.lunes ELSE disgen.lunes END + e.martes * CASE WHEN dismaq.martes > 0 THEN dismaq.martes WHEN dislin.martes > 0 THEN dislin.martes ELSE disgen.martes END + e.miercoles * CASE WHEN dismaq.miercoles > 0 THEN dismaq.miercoles WHEN dislin.miercoles > 0 THEN dislin.miercoles ELSE disgen.miercoles END + e.jueves * CASE WHEN dismaq.jueves > 0 THEN dismaq.jueves WHEN dislin.jueves > 0 THEN dislin.jueves ELSE disgen.jueves END + e.viernes * CASE WHEN dismaq.viernes > 0 THEN dismaq.viernes WHEN dislin.viernes > 0 THEN dislin.viernes ELSE disgen.viernes END + e.sabado * CASE WHEN dismaq.sabado > 0 THEN dismaq.sabado WHEN dislin.sabado > 0 THEN dislin.sabado ELSE disgen.sabado END + e.domingo * CASE WHEN dismaq.domingo > 0 THEN dismaq.domingo WHEN dislin.domingo > 0 THEN dislin.domingo ELSE disgen.domingo END) - IFNULL(SUM(c.tiemporeparacion + c.tiempollegada), 0)) / CASE WHEN COUNT(c.id) = 0 THEN 1 ELSE COUNT(c.id) END / ~ORM-0002~3600~ORM-0003~ AS mtbfc_m, IFNULL(d.reportest, 0) AS reportest, d.reporteid, h.reportefecha, h.reportests FROM " + this.servicio.rBD() + ".cat_areas a LEFT JOIN (SELECT d.AREA, COUNT(*) AS reportest, MAX(d.id) AS reporteid FROM " + this.servicio.rBD() + ".reportes d WHERE d.contabilizar = 'S' AND d.estatus <= 10 GROUP BY d.area) AS d ON a.id = d.AREA LEFT JOIN (SELECT CASE WHEN h.estatus = 0 THEN h.fecha ELSE h.inicio_atencion END reportefecha, h.estatus AS reportests, h.id FROM " + this.servicio.rBD() + ".reportes h WHERE h.contabilizar = 'S') AS h ON d.reporteid = h.id LEFT JOIN (SELECT id, maquina, linea, AREA, tiemporeparacion, tiempollegada FROM " + this.servicio.rBD() + ".reportes c WHERE c.contabilizar = 'S' AND c.estatus >= 100  AND c.fecha_reporte >= '" + this.fDesde + "' AND c.fecha_reporte <= '" + this.fHasta + "' ) AS c ON a.id = c.AREA LEFT JOIN " + this.servicio.rBD() + ".disponibilidad AS dismaq ON dismaq.maquina = c.maquina AND dismaq.estatus = 'A' LEFT JOIN " + this.servicio.rBD() + ".disponibilidad AS dislin ON dislin.linea = c.linea AND dislin.estatus = 'A', (SELECT COUNT(*) AS tdias, SUM(CASE WHEN dia = 2 THEN 1 ELSE 0 END) AS lunes, SUM(CASE WHEN dia = 3 THEN 1 ELSE 0 END) AS martes, SUM(CASE WHEN dia = 4 THEN 1 ELSE 0 END) AS miercoles, SUM(CASE WHEN dia = 5 THEN 1 ELSE 0 END) AS jueves, SUM(CASE WHEN dia = 6 THEN 1 ELSE 0 END) AS viernes, SUM(CASE WHEN dia = 7 THEN 1 ELSE 0 END) AS sabado, SUM(CASE WHEN dia = 1 THEN 1 ELSE 0 END) AS domingo FROM " + this.servicio.rBD() + ".dias WHERE  fecha >= '" + this.fDesde + "' AND fecha <= '" + this.fHasta + "' ) AS e, (SELECT * FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND maquina = 0 AND linea = 0) AS disgen GROUP BY a.nombre, a.id, a.referencia, e.tdias, d.reportest, d.reporteid, h.reportefecha, h.reportests) AS a LEFT JOIN (SELECT a.id, a.nombre, a.referencia, e.tdias AS tdias_y, IFNULL(SUM(c.tiemporeparacion + c.tiempollegada), 0) AS tiempo_c_y, COUNT(c.id) AS docs_y, SUM(e.lunes * CASE WHEN dismaq.lunes > 0 THEN dismaq.lunes WHEN dislin.lunes > 0 THEN dislin.lunes ELSE disgen.lunes END + e.martes * CASE WHEN dismaq.martes > 0 THEN dismaq.martes WHEN dislin.martes > 0 THEN dislin.martes ELSE disgen.martes END + e.miercoles * CASE WHEN dismaq.miercoles > 0 THEN dismaq.miercoles WHEN dislin.miercoles > 0 THEN dislin.miercoles ELSE disgen.miercoles END + e.jueves * CASE WHEN dismaq.jueves > 0 THEN dismaq.jueves WHEN dislin.jueves > 0 THEN dislin.jueves ELSE disgen.jueves END + e.viernes * CASE WHEN dismaq.viernes > 0 THEN dismaq.viernes WHEN dislin.viernes > 0 THEN dislin.viernes ELSE disgen.viernes END + e.sabado * CASE WHEN dismaq.sabado > 0 THEN dismaq.sabado WHEN dislin.sabado > 0 THEN dislin.sabado ELSE disgen.sabado END + e.domingo * CASE WHEN dismaq.domingo > 0 THEN dismaq.domingo WHEN dislin.domingo > 0 THEN dislin.domingo ELSE disgen.domingo END) AS tdisponible_y, IFNULL(SUM(c.tiemporeparacion + c.tiempollegada) / ~ORM-0002~3600~ORM-0003~ / COUNT(c.id), 0) AS mttrc_y, (SUM(e.lunes * CASE WHEN dismaq.lunes > 0 THEN dismaq.lunes WHEN dislin.lunes > 0 THEN dislin.lunes ELSE disgen.lunes END + e.martes * CASE WHEN dismaq.martes > 0 THEN dismaq.martes WHEN dislin.martes > 0 THEN dislin.martes ELSE disgen.martes END + e.miercoles * CASE WHEN dismaq.miercoles > 0 THEN dismaq.miercoles WHEN dislin.miercoles > 0 THEN dislin.miercoles ELSE disgen.miercoles END + e.jueves * CASE WHEN dismaq.jueves > 0 THEN dismaq.jueves WHEN dislin.jueves > 0 THEN dislin.jueves ELSE disgen.jueves END + e.viernes * CASE WHEN dismaq.viernes > 0 THEN dismaq.viernes WHEN dislin.viernes > 0 THEN dislin.viernes ELSE disgen.viernes END + e.sabado * CASE WHEN dismaq.sabado > 0 THEN dismaq.sabado WHEN dislin.sabado > 0 THEN dislin.sabado ELSE disgen.sabado END + e.domingo * CASE WHEN dismaq.domingo > 0 THEN dismaq.domingo WHEN dislin.domingo > 0 THEN dislin.domingo ELSE disgen.domingo END) - IFNULL(SUM(c.tiemporeparacion + c.tiempollegada), 0)) / CASE WHEN COUNT(c.id) = 0 THEN 1 ELSE COUNT(c.id) END / ~ORM-0002~3600~ORM-0003~ AS mtbfc_y FROM " + this.servicio.rBD() + ".cat_areas a LEFT JOIN (SELECT d.AREA, COUNT(*) AS reportest, MAX(d.id) AS reporteid FROM " + this.servicio.rBD() + ".reportes d WHERE d.contabilizar = 'S' AND d.estatus <= 10 GROUP BY d.area) AS d ON a.id = d.AREA LEFT JOIN (SELECT CASE WHEN h.estatus = 0 THEN h.fecha ELSE h.inicio_atencion END reportefecha, h.estatus AS reportests, h.id FROM " + this.servicio.rBD() + ".reportes h WHERE h.contabilizar = 'S') AS h ON d.reporteid = h.id LEFT JOIN (SELECT id, maquina, linea, AREA, tiemporeparacion, tiempollegada FROM " + this.servicio.rBD() + ".reportes c WHERE c.contabilizar = 'S' AND c.estatus >= 100  AND c.fecha_reporte >= '" + this.fDesdeY + "' AND c.fecha_reporte <= '" + this.fHastaY + "' ) AS c ON a.id = c.AREA LEFT JOIN " + this.servicio.rBD() + ".disponibilidad AS dismaq ON dismaq.maquina = c.maquina AND dismaq.estatus = 'A' LEFT JOIN " + this.servicio.rBD() + ".disponibilidad AS dislin ON dislin.linea = c.linea AND dislin.estatus = 'A' LEFT JOIN (SELECT maquina, SUM(tiempo) AS tiempo FROM " + this.servicio.rBD() + ".detalleparos f WHERE f.contabilizar = 'S'  AND f.fecha >= '" + this.fDesdeY + "' AND f.fecha <= '" + this.fHastaY + "'  AND f.tipo = 1 GROUP BY maquina) AS f ON c.maquina = f.maquina, (SELECT COUNT(*) AS tdias, SUM(CASE WHEN dia = 2 THEN 1 ELSE 0 END) AS lunes, SUM(CASE WHEN dia = 3 THEN 1 ELSE 0 END) AS martes, SUM(CASE WHEN dia = 4 THEN 1 ELSE 0 END) AS miercoles, SUM(CASE WHEN dia = 5 THEN 1 ELSE 0 END) AS jueves, SUM(CASE WHEN dia = 6 THEN 1 ELSE 0 END) AS viernes, SUM(CASE WHEN dia = 7 THEN 1 ELSE 0 END) AS sabado, SUM(CASE WHEN dia = 1 THEN 1 ELSE 0 END) AS domingo FROM " + this.servicio.rBD() + ".dias WHERE  fecha >= '" + this.fDesdeY + "' AND fecha <= '" + this.fHastaY + "' ) AS e, (SELECT * FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND maquina = 0 AND linea = 0) AS disgen GROUP BY a.nombre, a.id, a.referencia, e.tdias) AS b ON a.id = b.id;"// ORDER BY " + ordenDatos + ";";
      }

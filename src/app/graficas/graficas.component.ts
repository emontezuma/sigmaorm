    ...
    this.servicio.consultasBD(campos).subscribe( resp =>
    {
      ...
      this.parGrafica.overlap = (this.parGrafica.overlap == "R" || this.parGrafica.overlap == "rotate" ? "rotate" : "stagger");
        ...
        else if (this.grActual == 3)
        {
          ...
          sentencia = "SELECT d.nombre, d.referencia, c.linea, COUNT(*) AS docs, SUM(c.tiemporeparacion + c.tiempollegada) / ~ORM-0002~3600~ORM-0003~ AS tiempo, SUM(c.tiempollegada) / ~ORM-0002~3600~ORM-0003~ AS loca, SUM(c.tiemporeparacion) / ~ORM-0002~3600~ORM-0003~ AS repa, 0 AS porcentaje FROM " + this.servicio.rBD() + ".reportes c INNER JOIN " + this.servicio.rBD() + ".cat_lineas d ON c.linea = d.id WHERE c.contabilizar = 'S' AND c.estatus >= 100 AND c.fecha_reporte >= '" + this.fDesde + "' AND c.fecha_reporte <= '" + this.fHasta + "' " + this.filtroReportes + " GROUP BY c.linea, d.nombre " + tHaving + " ORDER BY " + ordenDatos

          if (this.graficaActual == 2)
          {
            sentencia = "SELECT d.nombre, d.referencia, c.maquina, COUNT(*) AS docs, SUM(c.tiemporeparacion + c.tiempollegada) / ~ORM-0002~3600~ORM-0003~ AS tiempo, SUM(c.tiempollegada) / ~ORM-0002~3600~ORM-0003~ AS loca, SUM(c.tiemporeparacion) / ~ORM-0002~3600~ORM-0003~ AS repa, 0 AS porcentaje FROM " + this.servicio.rBD() + ".reportes c INNER JOIN " + this.servicio.rBD() + ".cat_maquinas d ON c.maquina = d.id WHERE c.contabilizar = 'S' AND c.estatus >= 100 AND c.fecha_reporte >= '" + this.fDesde + "' AND c.fecha_reporte <= '" + this.fHasta + "' " + this.filtroReportes + " GROUP BY c.maquina, d.nombre " + tHaving + " ORDER BY " + ordenDatos
          }
          else if (this.graficaActual == 3)
          {
            sentencia = "SELECT d.nombre, d.referencia, c.area, COUNT(*) AS docs, SUM(c.tiemporeparacion + c.tiempollegada) / ~ORM-0002~3600~ORM-0003~ AS tiempo, SUM(c.tiempollegada) / ~ORM-0002~3600~ORM-0003~ AS loca, SUM(c.tiemporeparacion) / ~ORM-0002~3600~ORM-0003~ AS repa, 0 AS porcentaje FROM " + this.servicio.rBD() + ".reportes c INNER JOIN " + this.servicio.rBD() + ".cat_areas d ON c.area = d.id WHERE c.contabilizar = 'S' AND c.estatus >= 100 AND c.fecha_reporte >= '" + this.fDesde + "' AND c.fecha_reporte <= '" + this.fHasta + "' " + this.filtroReportes + " GROUP BY c.area, d.nombre " + tHaving + " ORDER BY " + ordenDatos
          }
          else if (this.graficaActual == 4)
          {
            sentencia = "SELECT d.nombre, d.referencia, c.falla_ajustada, COUNT(*) AS docs, SUM(c.tiemporeparacion + c.tiempollegada) / ~ORM-0002~3600~ORM-0003~ AS tiempo, SUM(c.tiempollegada) / ~ORM-0002~3600~ORM-0003~ AS loca, SUM(c.tiemporeparacion) / ~ORM-0002~3600~ORM-0003~ AS repa, 0 AS porcentaje FROM " + this.servicio.rBD() + ".reportes c INNER JOIN " + this.servicio.rBD() + ".cat_fallas d ON c.falla_ajustada = d.id WHERE c.contabilizar = 'S' AND c.estatus >= 100 AND c.fecha_reporte >= '" + this.fDesde + "' AND c.fecha_reporte <= '" + this.fHasta + "' " + this.filtroReportes + " GROUP BY c.falla_ajustada, d.nombre " + tHaving + " ORDER BY " + ordenDatos
          }
          else if (this.graficaActual == 5)
          {
            sentencia = "SELECT IFNULL(b.nombre, '" + this.servicio.rTraduccion()[8] + "') AS nombre, '' AS referencia, d.tipo AS id, COUNT(*) AS docs, SUM(c.tiemporeparacion + c.tiempollegada) / ~ORM-0002~3600~ORM-0003~ AS tiempo, SUM(c.tiempollegada) / ~ORM-0002~3600~ORM-0003~ AS loca, SUM(c.tiemporeparacion) / ~ORM-0002~3600~ORM-0003~ AS repa, 0 AS porcentaje FROM " + this.servicio.rBD() + ".reportes c INNER JOIN " + this.servicio.rBD() + ".cat_maquinas d ON c.maquina = d.id LEFT JOIN " + this.servicio.rBD() + ".cat_generales b ON d.tipo = b.id WHERE c.contabilizar = 'S' AND c.estatus >= 100 AND c.fecha_reporte >= '" + this.fDesde + "' AND c.fecha_reporte <= '" + this.fHasta + "' " + this.filtroReportes + " GROUP BY id, nombre " + tHaving + " ORDER BY " + ordenDatos
          }
          else if (this.graficaActual == 6)
          {
            sentencia = "SELECT IFNULL(b.nombre, '" + this.servicio.rTraduccion()[8] + "') AS nombre, '' AS referencia, d.agrupador_1 AS id, COUNT(*) AS docs, SUM(c.tiemporeparacion + c.tiempollegada) / ~ORM-0002~3600~ORM-0003~ AS tiempo, SUM(c.tiempollegada) / ~ORM-0002~3600~ORM-0003~ AS loca, SUM(c.tiemporeparacion) / ~ORM-0002~3600~ORM-0003~ AS repa, 0 AS porcentaje FROM " + this.servicio.rBD() + ".reportes c INNER JOIN " + this.servicio.rBD() + ".cat_maquinas d ON c.maquina = d.id LEFT JOIN " + this.servicio.rBD() + ".cat_generales b ON d.agrupador_1 = b.id WHERE c.contabilizar = 'S' AND c.estatus >= 100 AND c.fecha_reporte >= '" + this.fDesde + "' AND c.fecha_reporte <= '" + this.fHasta + "' " + this.filtroReportes + " GROUP BY id, nombre " + tHaving + " ORDER BY " + ordenDatos
          }
          else if (this.graficaActual == 7)
          {
            sentencia = "SELECT IFNULL(b.nombre, '" + this.servicio.rTraduccion()[8] + "') AS nombre, '' AS referencia, d.agrupador_2 AS id, COUNT(*) AS docs, SUM(c.tiemporeparacion + c.tiempollegada) / ~ORM-0002~3600~ORM-0003~ AS tiempo, SUM(c.tiempollegada) / ~ORM-0002~3600~ORM-0003~ AS loca, SUM(c.tiemporeparacion) / ~ORM-0002~3600~ORM-0003~ AS repa, 0 AS porcentaje FROM " + this.servicio.rBD() + ".reportes c INNER JOIN " + this.servicio.rBD() + ".cat_maquinas d ON c.maquina = d.id LEFT JOIN " + this.servicio.rBD() + ".cat_generales b ON d.agrupador_2 = b.id WHERE c.contabilizar = 'S' AND c.estatus >= 100 AND c.fecha_reporte >= '" + this.fDesde + "' AND c.fecha_reporte <= '" + this.fHasta + "' " + this.filtroReportes + " GROUP BY id, nombre " + tHaving + " ORDER BY " + ordenDatos
          }
          else if (this.graficaActual == 8)
          {
            sentencia = "SELECT IFNULL(b.nombre, '" + this.servicio.rTraduccion()[8] + "') AS nombre, '' AS referencia, d.agrupador_1 AS id, COUNT(*) AS docs, SUM(c.tiemporeparacion + c.tiempollegada) / ~ORM-0002~3600~ORM-0003~ AS tiempo, SUM(c.tiempollegada) / ~ORM-0002~3600~ORM-0003~ AS loca, SUM(c.tiemporeparacion) / ~ORM-0002~3600~ORM-0003~ AS repa, 0 AS porcentaje FROM " + this.servicio.rBD() + ".reportes c INNER JOIN " + this.servicio.rBD() + ".cat_fallas d ON c.falla_ajustada = d.id LEFT JOIN " + this.servicio.rBD() + ".cat_generales b ON d.agrupador_1 = b.id WHERE c.contabilizar = 'S' AND c.estatus >= 100 AND c.fecha_reporte >= '" + this.fDesde + "' AND c.fecha_reporte <= '" + this.fHasta + "' " + this.filtroReportes + " GROUP BY id, nombre " + tHaving + " ORDER BY " + ordenDatos
          }
          else if (this.graficaActual == 9)
          {
            sentencia = "SELECT IFNULL(b.nombre, '" + this.servicio.rTraduccion()[8] + "') AS nombre, '' AS referencia, d.agrupador_2 AS id, COUNT(*) AS docs, SUM(c.tiemporeparacion + c.tiempollegada) / ~ORM-0002~3600~ORM-0003~ AS tiempo, SUM(c.tiempollegada) / ~ORM-0002~3600~ORM-0003~ AS loca, SUM(c.tiemporeparacion) / ~ORM-0002~3600~ORM-0003~ AS repa, 0 AS porcentaje FROM " + this.servicio.rBD() + ".reportes c INNER JOIN " + this.servicio.rBD() + ".cat_fallas d ON c.falla_ajustada = d.id LEFT JOIN " + this.servicio.rBD() + ".cat_generales b ON d.agrupador_2 = b.id WHERE c.contabilizar = 'S' AND c.estatus >= 100 AND c.fecha_reporte >= '" + this.fDesde + "' AND c.fecha_reporte <= '" + this.fHasta + "' " + this.filtroReportes + " GROUP BY id, nombre " + tHaving + " ORDER BY " + ordenDatos
          }
          else if (this.graficaActual == 10)
          {
            sentencia = "SELECT c.fecha_reporte AS nombre, '' AS referencia, 0 AS id, COUNT(*) AS docs, SUM(c.tiemporeparacion + c.tiempollegada) / ~ORM-0002~3600~ORM-0003~ AS tiempo, SUM(c.tiempollegada) / ~ORM-0002~3600~ORM-0003~ AS loca, SUM(c.tiemporeparacion) / ~ORM-0002~3600~ORM-0003~ AS repa, 0 AS porcentaje FROM " + this.servicio.rBD() + ".reportes c WHERE c.contabilizar = 'S' AND c.estatus >= 100 AND c.fecha_reporte >= '" + this.fDesde + "' AND c.fecha_reporte <= '" + this.fHasta + "' " + this.filtroReportes + " GROUP BY nombre " + tHaving + " ORDER BY " + ordenDatos
          }
          else if (this.graficaActual == 11)
          {
          ...
          {
            sentencia = "SELECT d.nombre, d.referencia, c.tecnicoatend, COUNT(*) AS docs, SUM(c.tiemporeparacion + c.tiempollegada) / ~ORM-0002~3600~ORM-0003~ AS tiempo, SUM(c.tiempollegada) / ~ORM-0002~3600~ORM-0003~ AS loca, SUM(c.tiemporeparacion) / ~ORM-0002~3600~ORM-0003~ AS repa, 0 AS porcentaje FROM " + this.servicio.rBD() + ".reportes c INNER JOIN " + this.servicio.rBD() + ".cat_usuarios d ON c.tecnicoatend = d.id WHERE c.contabilizar = 'S' AND c.estatus >= 100 AND c.fecha_reporte >= '" + this.fDesde + "' AND c.fecha_reporte <= '" + this.fHasta + "' " + this.filtroReportes + " GROUP BY c.tecnicoatend, d.nombre " + tHaving + " ORDER BY " + ordenDatos
          }
        }
        else if (this.grActual == 4)
        {
        ...
        else if (this.grActual == 6)
        {
          ...
          sentencia = "SELECT IFNULL(b.nombre, '" + this.servicio.rTraduccion()[8] + "') AS nombre, b.referencia, a.linea AS id, IFNULL(SUM(i.rechazos), 0) AS docs, IFNULL(SUM(i.calidad), 0) / ~ORM-0002~3600~ORM-0003~ AS tiempo, 0 AS porcentaje FROM (SELECT i.equipo, SUM(i.calidad) AS rechazos, SUM(i.calidad_tc) AS calidad FROM (SELECT a.equipo, a.area, a.tipo, a.fecha AS dia, a.parte, a.turno, a.lote AS orden, a.cantidad AS calidad, a.cantidad_tc AS calidad_tc FROM " + this.servicio.rBD() + ".detallerechazos a INNER JOIN " + this.servicio.rBD() + ".lecturas_cortes b ON a.corte = b.id UNION ALL SELECT equipo, 0 AS area, 0 AS tipo, dia, parte, turno, orden, calidad, calidad_tc FROM " + this.servicio.rBD() + ".lecturas_cortes WHERE calidad - calidad_clasificada > 0 UNION ALL SELECT equipo, area, tipo, fecha AS dia, parte, turno, lote AS orden, cantidad AS calidad, cantidad_tc AS calidad_tc FROM " + this.servicio.rBD() + ".detallerechazos WHERE corte = 0) AS i LEFT JOIN sigma.cat_maquinas j ON i.equipo = j.id WHERE i.dia >= '" + this.fDesde + "' AND i.dia <= '" + this.fHasta + "' " + this.filtroRechazos + " GROUP BY i.equipo) AS i LEFT JOIN " + this.servicio.rBD() + ".cat_maquinas a ON i.equipo = a.id AND a.oee = 'S' LEFT JOIN " + this.servicio.rBD() + ".cat_lineas b ON a.linea = b.id GROUP BY 1 " + tHaving + " ORDER BY " + ordenDatos;

          if (this.graficaActual == 2)
          {
            sentencia = "SELECT IFNULL(a.nombre, '" + this.servicio.rTraduccion()[8] + "') AS nombre, a.referencia, a.id, IFNULL(SUM(i.rechazos), 0) AS docs, IFNULL(SUM(i.calidad), 0) / ~ORM-0002~3600~ORM-0003~ AS tiempo, 0 AS porcentaje FROM (SELECT i.equipo, SUM(i.calidad) AS rechazos, SUM(i.calidad_tc) AS calidad FROM (SELECT a.equipo, a.area, a.tipo, a.fecha AS dia, a.parte, a.turno, a.lote AS orden, a.cantidad AS calidad, a.cantidad_tc AS calidad_tc FROM " + this.servicio.rBD() + ".detallerechazos a INNER JOIN " + this.servicio.rBD() + ".lecturas_cortes b ON a.corte = b.id UNION ALL SELECT equipo, 0 AS area, 0 AS tipo, dia, parte, turno, orden, calidad, calidad_tc FROM " + this.servicio.rBD() + ".lecturas_cortes WHERE calidad - calidad_clasificada > 0 UNION ALL SELECT equipo, area, tipo, fecha AS dia, parte, turno, lote AS orden, cantidad AS calidad, cantidad_tc AS calidad_tc FROM " + this.servicio.rBD() + ".detallerechazos WHERE corte = 0) AS i LEFT JOIN sigma.cat_maquinas j ON i.equipo = j.id WHERE i.dia >= '" + this.fDesde + "' AND i.dia <= '" + this.fHasta + "' " + this.filtroRechazos + " GROUP BY i.equipo) AS i LEFT JOIN " + this.servicio.rBD() + ".cat_maquinas a ON i.equipo = a.id WHERE a.oee = 'S' GROUP BY 1 " + tHaving + " ORDER BY " + ordenDatos;

          }
          else if (this.graficaActual == 3)
          {
            sentencia = "SELECT IFNULL(a.nombre, '" + this.servicio.rTraduccion()[8] + "') AS nombre, '' AS referencia, a.id, IFNULL(SUM(i.rechazos), 0) AS docs, IFNULL(SUM(i.calidad), 0) / ~ORM-0002~3600~ORM-0003~ AS tiempo, 0 AS porcentaje FROM (SELECT i.area, SUM(i.calidad) AS rechazos, SUM(i.calidad_tc) AS calidad FROM (SELECT a.equipo, a.area, a.tipo, a.fecha AS dia, a.parte, a.turno, a.lote AS orden, a.cantidad AS calidad, a.cantidad_tc AS calidad_tc FROM " + this.servicio.rBD() + ".detallerechazos a INNER JOIN " + this.servicio.rBD() + ".lecturas_cortes b ON a.corte = b.id UNION ALL SELECT equipo, 0 AS area, 0 AS tipo, dia, parte, turno, orden, calidad, calidad_tc FROM " + this.servicio.rBD() + ".lecturas_cortes WHERE calidad - calidad_clasificada > 0 UNION ALL SELECT equipo, area, tipo, fecha AS dia, parte, turno, lote AS orden, cantidad AS calidad, cantidad_tc AS calidad_tc FROM " + this.servicio.rBD() + ".detallerechazos WHERE corte = 0) AS i LEFT JOIN sigma.cat_maquinas j ON i.equipo = j.id WHERE i.dia >= '" + this.fDesde + "' AND i.dia <= '" + this.fHasta + "' " + this.filtroRechazos + " GROUP BY i.area) AS i LEFT JOIN " + this.servicio.rBD() + ".cat_generales a ON i.area = a.id GROUP BY 1 " + tHaving + " ORDER BY " + ordenDatos;
          }
          else if (this.graficaActual == 4)
          {
            sentencia = "SELECT IFNULL(a.nombre, '" + this.servicio.rTraduccion()[3759] + "') AS nombre, '' AS referencia, a.id, IFNULL(SUM(i.rechazos), 0) AS docs, IFNULL(SUM(i.calidad), 0) / ~ORM-0002~3600~ORM-0003~ AS tiempo, 0 AS porcentaje FROM (SELECT i.tipo, SUM(i.calidad) AS rechazos, SUM(i.calidad_tc) AS calidad FROM (SELECT a.equipo, a.area, a.tipo, a.fecha AS dia, a.parte, a.turno, a.lote AS orden, a.cantidad AS calidad, a.cantidad_tc AS calidad_tc FROM " + this.servicio.rBD() + ".detallerechazos a INNER JOIN " + this.servicio.rBD() + ".lecturas_cortes b ON a.corte = b.id UNION ALL SELECT equipo, 0 AS area, 0 AS tipo, dia, parte, turno, orden, calidad, calidad_tc FROM " + this.servicio.rBD() + ".lecturas_cortes WHERE calidad - calidad_clasificada > 0 UNION ALL SELECT equipo, area, tipo, fecha AS dia, parte, turno, lote AS orden, cantidad AS calidad, cantidad_tc AS calidad_tc FROM " + this.servicio.rBD() + ".detallerechazos WHERE corte = 0) AS i LEFT JOIN sigma.cat_maquinas j ON i.equipo = j.id WHERE i.dia >= '" + this.fDesde + "' AND i.dia <= '" + this.fHasta + "' " + this.filtroRechazos + " GROUP BY i.tipo) AS i LEFT JOIN " + this.servicio.rBD() + ".cat_generales a ON i.tipo = a.id GROUP BY 1 " + tHaving + " ORDER BY " + ordenDatos;
          }
          else if (this.graficaActual == 5)
          {

            sentencia = "SELECT i.dia AS nombre, '' AS referencia, 0 AS id, IFNULL(SUM(i.rechazos), 0) AS docs, IFNULL(SUM(i.calidad), 0) / ~ORM-0002~3600~ORM-0003~ AS tiempo, 0 AS porcentaje FROM (SELECT i.dia, SUM(i.calidad) AS rechazos, SUM(i.calidad_tc) AS calidad FROM (SELECT a.equipo, a.area, a.tipo, a.fecha AS dia, a.parte, a.turno, a.lote AS orden, a.cantidad AS calidad, a.cantidad_tc AS calidad_tc FROM " + this.servicio.rBD() + ".detallerechazos a INNER JOIN " + this.servicio.rBD() + ".lecturas_cortes b ON a.corte = b.id UNION ALL SELECT equipo, 0 AS area, 0 AS tipo, dia, parte, turno, orden, calidad, calidad_tc FROM " + this.servicio.rBD() + ".lecturas_cortes WHERE calidad - calidad_clasificada > 0 UNION ALL SELECT equipo, area, tipo, fecha AS dia, parte, turno, lote AS orden, cantidad AS calidad, cantidad_tc AS calidad_tc FROM " + this.servicio.rBD() + ".detallerechazos WHERE corte = 0) AS i LEFT JOIN sigma.cat_maquinas j ON i.equipo = j.id WHERE i.dia >= '" + this.fDesde + "' AND i.dia <= '" + this.fHasta + "' " + this.filtroRechazos + " GROUP BY i.dia) AS i GROUP BY 1 ORDER BY " + ordenDatos;
            
          }
          else if (this.graficaActual == 6)
          {
            sentencia = "SELECT CONCAT(YEAR(i.dia), '/', WEEK(i.dia)) AS nombre, STR_TO_DATE(CONCAT(DATE_FORMAT(i.dia, '%x/%v'), ' Monday'), '%x/%v %W') AS referencia, 0 AS id, IFNULL(SUM(i.rechazos), 0) AS docs, IFNULL(SUM(i.calidad), 0) / ~ORM-0002~3600~ORM-0003~ AS tiempo, 0 AS porcentaje FROM (SELECT i.dia, SUM(i.calidad) AS rechazos, SUM(i.calidad_tc) AS calidad FROM (SELECT a.equipo, a.area, a.tipo, a.fecha AS dia, a.parte, a.turno, a.lote AS orden, a.cantidad AS calidad, a.cantidad_tc AS calidad_tc FROM " + this.servicio.rBD() + ".detallerechazos a INNER JOIN " + this.servicio.rBD() + ".lecturas_cortes b ON a.corte = b.id UNION ALL SELECT equipo, 0 AS area, 0 AS tipo, dia, parte, turno, orden, calidad, calidad_tc FROM " + this.servicio.rBD() + ".lecturas_cortes WHERE calidad - calidad_clasificada > 0 UNION ALL SELECT equipo, area, tipo, fecha AS dia, parte, turno, lote AS orden, cantidad AS calidad, cantidad_tc AS calidad_tc FROM " + this.servicio.rBD() + ".detallerechazos WHERE corte = 0) AS i LEFT JOIN sigma.cat_maquinas j ON i.equipo = j.id WHERE i.dia >= '" + this.fDesde + "' AND i.dia <= '" + this.fHasta + "' " + this.filtroRechazos + " GROUP BY i.dia) AS i GROUP BY 1 ORDER BY " + ordenDatos;
            
          }
          else if (this.graficaActual == 7)
          {
            sentencia = "SELECT CONCAT(YEAR(i.dia), '/', MONTH(i.dia)) AS nombre, '' AS referencia, 0 AS id, IFNULL(SUM(i.rechazos), 0) AS docs, IFNULL(SUM(i.calidad), 0) / ~ORM-0002~3600~ORM-0003~ AS tiempo, 0 AS porcentaje FROM (SELECT i.dia, SUM(i.calidad) AS rechazos, SUM(i.calidad_tc) AS calidad FROM (SELECT a.equipo, a.area, a.tipo, a.fecha AS dia, a.parte, a.turno, a.lote AS orden, a.cantidad AS calidad, a.cantidad_tc AS calidad_tc FROM " + this.servicio.rBD() + ".detallerechazos a INNER JOIN " + this.servicio.rBD() + ".lecturas_cortes b ON a.corte = b.id UNION ALL SELECT equipo, 0 AS area, 0 AS tipo, dia, parte, turno, orden, calidad, calidad_tc FROM " + this.servicio.rBD() + ".lecturas_cortes WHERE calidad - calidad_clasificada > 0 UNION ALL SELECT equipo, area, tipo, fecha AS dia, parte, turno, lote AS orden, cantidad AS calidad, cantidad_tc AS calidad_tc FROM " + this.servicio.rBD() + ".detallerechazos WHERE corte = 0) AS i LEFT JOIN sigma.cat_maquinas j ON i.equipo = j.id WHERE i.dia >= '" + this.fDesde + "' AND i.dia <= '" + this.fHasta + "' " + this.filtroRechazos + " GROUP BY i.dia) AS i GROUP BY 1 ORDER BY " + ordenDatos;
          }
        ...
        else if (this.grActual == 7)
        {
          ...
          if (this.graficaActual <= 3)
          {
            ...
            sentencia = "SELECT d.nombre, " + (this.graficaActual == 5 ? "d.referencia, " : "") + tablaID + " AS id, COUNT(*) AS docs, SUM(CASE WHEN c.evaluacion = 'N' THEN 1 ELSE 0 END) AS nega, SUM(CASE WHEN c.evaluacion = 'P' THEN 1 ELSE 0 END) AS posi, CASE WHEN COUNT(*) > 0 THEN SUM(CASE WHEN c.evaluacion = 'P' THEN 1 ELSE 0 END) / COUNT(*) * 100 ELSE 0 END AS positivos, SUM(c.tiempo) / ~ORM-0002~3600~ORM-0003~ AS tiempo, 0 AS porcentaje FROM " + this.servicio.rBD() + ".rkanban_cab c INNER JOIN " + this.servicio.rBD() + tablaUnion + " = d.id WHERE c.estado >= 50 AND c.inicio >= '" + this.fDesde + " 00:00:00' AND c.inicio <= '" + this.fHasta + " 23:59:59' " + this.filtroKanban + " GROUP BY d.nombre " + tHaving + " ORDER BY " + ordenDatos
          }
          else 
          {
            let ordenDatos = "5"; 
            ...
            if (this.graficaActual == 4)
            {
              sentencia = "SELECT DATE_FORMAT(c.inicio, '%d/%m/%Y') AS nombre, COUNT(*) AS docs, SUM(CASE WHEN c.evaluacion = 'N' THEN 1 ELSE 0 END) AS nega, SUM(CASE WHEN c.evaluacion = 'P' THEN 1 ELSE 0 END) AS posi, CASE WHEN COUNT(*) > 0 THEN SUM(CASE WHEN c.evaluacion = 'P' THEN 1 ELSE 0 END) / COUNT(*) * 100 ELSE 0 END AS positivos, SUM(c.tiempo) / ~ORM-0002~3600~ORM-0003~ AS tiempo, 0 AS porcentaje FROM " + this.servicio.rBD() + ".rkanban_cab c WHERE c.estado >= 50 AND c.inicio >= '" + this.fDesde + " 00:00:00' AND c.inicio <= '" + this.fHasta + " 23:59:59' " + this.filtroKanban + " GROUP BY DATE_FORMAT(c.inicio, '%d/%m/%Y') " + tHaving + " ORDER BY " + ordenDatos
            }
            else if (this.graficaActual == 5)
            {
              let ordenDatos = "6"; 
              ...
              sentencia = "SELECT CONCAT(YEAR(c.inicio), '/', WEEK(c.inicio))  AS nombre, STR_TO_DATE(CONCAT(DATE_FORMAT(c.inicio,'%x/%v'), ' Monday'), '%x/%v %W') AS referencia, COUNT(*) AS docs, SUM(CASE WHEN c.evaluacion = 'N' THEN 1 ELSE 0 END) AS nega, SUM(CASE WHEN c.evaluacion = 'P' THEN 1 ELSE 0 END) AS posi, CASE WHEN COUNT(*) > 0 THEN SUM(CASE WHEN c.evaluacion = 'P' THEN 1 ELSE 0 END) / COUNT(*) * 100 ELSE 0 END AS positivos, SUM(c.tiempo) / ~ORM-0002~3600~ORM-0003~ AS tiempo, 0 AS porcentaje FROM " + this.servicio.rBD() + ".rkanban_cab c WHERE c.estado >= 50 AND c.inicio >= '" + this.fDesde + " 00:00:00' AND c.inicio <= '" + this.fHasta + " 23:59:59' " + this.filtroKanban + " GROUP BY 1 " + tHaving + " ORDER BY " + ordenDatos
            }
            else if (this.graficaActual == 6)
            {
              sentencia = "SELECT CONCAT(YEAR(c.inicio), '/', MONTH(c.inicio)) AS nombre, COUNT(*) AS docs, SUM(CASE WHEN c.evaluacion = 'N' THEN 1 ELSE 0 END) AS nega, SUM(CASE WHEN c.evaluacion = 'P' THEN 1 ELSE 0 END) AS posi, CASE WHEN COUNT(*) > 0 THEN SUM(CASE WHEN c.evaluacion = 'P' THEN 1 ELSE 0 END) / COUNT(*) * 100 ELSE 0 END AS positivos, SUM(c.tiempo) / ~ORM-0002~3600~ORM-0003~ AS tiempo, 0 AS porcentaje FROM " + this.servicio.rBD() + ".rkanban_cab c WHERE c.estado >= 50 AND c.inicio >= '" + this.fDesde + " 00:00:00' AND c.inicio <= '" + this.fHasta + " 23:59:59' " + this.filtroKanban + " GROUP BY 1 " + tHaving + " ORDER BY " + ordenDatos
            }
          }
        }
        else if (this.grActual == 8)
        {
          ...
          if (this.graficaActual <= 5)
          {
            ...
            sentencia = "SELECT d.nombre, " + (this.graficaActual == 5 ? "d.referencia, " : "") + tablaID + " AS id, COUNT(*) AS docs, SUM(CASE WHEN c.evaluacion = 'N' THEN 1 ELSE 0 END) AS nega, SUM(CASE WHEN c.evaluacion = 'P' THEN 1 ELSE 0 END) AS posi, CASE WHEN COUNT(*) > 0 THEN SUM(CASE WHEN c.evaluacion = 'P' THEN 1 ELSE 0 END) / COUNT(*) * 100 ELSE 0 END AS positivos, SUM(c.tiempo) / ~ORM-0002~3600~ORM-0003~ AS tiempo, 0 AS porcentaje FROM " + this.servicio.rBD() + ".kanban_solicitudes c INNER JOIN " + this.servicio.rBD() + tablaUnion + " = d.id WHERE c.contabilizar = 'S' AND c.estado >= 50 AND c.fecha_reporte >= '" + this.fDesde + "' AND c.fecha_reporte <= '" + this.fHasta + "' " + this.filtroKanban + " GROUP BY d.nombre " + tHaving + " ORDER BY " + ordenDatos
          }
          else 
          {
            let ordenDatos = "5"; 
            ...
            if (this.graficaActual == 6)
            {
              sentencia = "SELECT c.fecha_reporte AS nombre, COUNT(*) AS docs, SUM(CASE WHEN c.evaluacion = 'N' THEN 1 ELSE 0 END) AS nega, SUM(CASE WHEN c.evaluacion = 'P' THEN 1 ELSE 0 END) AS posi, CASE WHEN COUNT(*) > 0 THEN SUM(CASE WHEN c.evaluacion = 'P' THEN 1 ELSE 0 END) / COUNT(*) * 100 ELSE 0 END AS positivos, SUM(c.tiempo) / ~ORM-0002~3600~ORM-0003~ AS tiempo, 0 AS porcentaje FROM " + this.servicio.rBD() + ".kanban_solicitudes c WHERE c.contabilizar = 'S' AND c.estado >= 50 AND c.fecha_reporte >= '" + this.fDesde + "' AND c.fecha_reporte <= '" + this.fHasta + "' " + this.filtroKanban + " GROUP BY 1 " + tHaving + " ORDER BY " + ordenDatos
            }
            else if (this.graficaActual == 7)
            {
              let ordenDatos = "6"; 
              ...
              sentencia = "SELECT CONCAT(YEAR(c.fecha_reporte), '/', WEEK(c.fecha_reporte))  AS nombre, STR_TO_DATE(CONCAT(DATE_FORMAT(c.fecha_reporte,'%x/%v'), ' Monday'), '%x/%v %W') AS referencia, COUNT(*) AS docs, SUM(CASE WHEN c.evaluacion = 'N' THEN 1 ELSE 0 END) AS nega, SUM(CASE WHEN c.evaluacion = 'P' THEN 1 ELSE 0 END) AS posi, CASE WHEN COUNT(*) > 0 THEN SUM(CASE WHEN c.evaluacion = 'P' THEN 1 ELSE 0 END) / COUNT(*) * 100 ELSE 0 END AS positivos, SUM(c.tiempo) / ~ORM-0002~3600~ORM-0003~ AS tiempo, 0 AS porcentaje FROM " + this.servicio.rBD() + ".kanban_solicitudes c WHERE c.contabilizar = 'S' AND c.estado >= 50 AND c.fecha_reporte >= '" + this.fDesde + "' AND c.fecha_reporte <= '" + this.fHasta + "' " + this.filtroKanban + " GROUP BY 1 " + tHaving + " ORDER BY " + ordenDatos
            }
            else if (this.graficaActual == 8)
            {
              sentencia = "SELECT CONCAT(YEAR(c.fecha_reporte), '/', MONTH(c.fecha_reporte)) AS nombre, COUNT(*) AS docs, SUM(CASE WHEN c.evaluacion = 'N' THEN 1 ELSE 0 END) AS nega, SUM(CASE WHEN c.evaluacion = 'P' THEN 1 ELSE 0 END) AS posi, CASE WHEN COUNT(*) > 0 THEN SUM(CASE WHEN c.evaluacion = 'P' THEN 1 ELSE 0 END) / COUNT(*) * 100 ELSE 0 END AS positivos, SUM(c.tiempo) / ~ORM-0002~3600~ORM-0003~ AS tiempo, 0 AS porcentaje FROM " + this.servicio.rBD() + ".kanban_solicitudes c WHERE c.contabilizar = 'S' AND c.estado >= 50 AND c.fecha_reporte >= '" + this.fDesde + "' AND c.fecha_reporte <= '" + this.fHasta + "' " + this.filtroKanban + " GROUP BY 1 " + tHaving + " ORDER BY " + ordenDatos
            }
          }
        }

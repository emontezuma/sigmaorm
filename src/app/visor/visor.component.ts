...
animGlow(onOff: number, gaussian: SNAPSVG_TYPE.Paper) {
  ...
  leerBD()
  {
    ...
    let sentencia = "SELECT * FROM (SELECT * FROM (SELECT 1, 'A' AS mitipo, a.id AS id2, CONCAT('A-',a.id) AS id, a.estatus, a.alarmado_atender, a.alarmado_atendido, a.inicio_atencion, a.fecha, CASE WHEN a.estatus = 0 THEN a.fecha ELSE a.inicio_atencion END AS fechac, IFNULL(b.nombre, '" + this.servicio.rTraduccion()[8] + "') AS nlinea, IFNULL(c.nombre, '" + this.servicio.rTraduccion()[8] + "') AS nmaquina, IFNULL(d.nombre, '" + this.servicio.rTraduccion()[8] + "') AS narea, IFNULL(e.nombre, '" + this.servicio.rTraduccion()[8] + "') AS nfalla, IFNULL(f.nombre, '" + this.servicio.rTraduccion()[8] + "') AS nsolicitante FROM " + this.servicio.rBD() + ".reportes a LEFT JOIN " + this.servicio.rBD() + ".cat_lineas b ON a.linea = b.id LEFT JOIN " + this.servicio.rBD() + ".cat_maquinas c ON a.maquina = c.id LEFT JOIN " + this.servicio.rBD() + ".cat_areas d ON a.area = d.id LEFT JOIN " + this.servicio.rBD() + ".cat_fallas e ON a.falla = e.id LEFT JOIN " + this.servicio.rBD() + ".cat_usuarios f ON a.solicitante = f.id WHERE " + filtroANDON + filtroFecha + ") AS q1 UNION (SELECT 1, 'K' AS mitipo, a.id AS id2, CONCAT('K-',a.id) AS id, 0 AS estatus, a.alarmado AS alarmado_atender, '' AS alarmado_atendido, a.fecha_sugerida, a.fecha_sugerida, a.fecha_sugerida AS fechac, '" + this.servicio.rTraduccion()[8] + "' AS nlinea, IFNULL(c.nombre, '" + this.servicio.rTraduccion()[8] + "') AS nmaquina, IFNULL(d.nombre, '" + this.servicio.rTraduccion()[8] + "') AS narea, IFNULL(e.nombre, '" + this.servicio.rTraduccion()[8] + "') AS nfalla, IFNULL(f.nombre, '" + this.servicio.rTraduccion()[8] + "') AS nsolicitante FROM " + this.servicio.rBD() + ".kanban_solicitudes a LEFT JOIN " + this.servicio.rBD() + ".cat_procesos c ON a.proceso = c.id LEFT JOIN " + this.servicio.rBD() + ".cat_areas d ON a.area = d.id LEFT JOIN " + this.servicio.rBD() + ".cat_partes e ON a.parte = e.id LEFT JOIN " + this.servicio.rBD() + ".cat_usuarios f ON a.solicitante = f.id WHERE estado < 40" + filtroFecha + ") UNION (SELECT 2, 'A' AS mitipo, a.id AS id2, CONCAT('A-',a.id) AS id, a.estatus, a.alarmado_atender, a.alarmado_atendido, a.inicio_atencion, a.fecha, CASE WHEN a.estatus = 0 THEN a.fecha ELSE a.inicio_atencion END AS fechac, IFNULL(b.nombre, '" + this.servicio.rTraduccion()[8] + "') AS nlinea, IFNULL(c.nombre, '" + this.servicio.rTraduccion()[8] + "') AS nmaquina, IFNULL(d.nombre, '" + this.servicio.rTraduccion()[8] + "') AS narea, IFNULL(e.nombre, '" + this.servicio.rTraduccion()[8] + "') AS nfalla, IFNULL(f.nombre, '" + this.servicio.rTraduccion()[8] + "') AS nsolicitante FROM " + this.servicio.rBD() + ".reportes a LEFT JOIN " + this.servicio.rBD() + ".cat_lineas b ON a.linea = b.id LEFT JOIN " + this.servicio.rBD() + ".cat_maquinas c ON a.maquina = c.id LEFT JOIN " + this.servicio.rBD() + ".cat_areas d ON a.area = d.id LEFT JOIN " + this.servicio.rBD() + ".cat_fallas e ON a.falla = e.id LEFT JOIN " + this.servicio.rBD() + ".cat_usuarios f ON a.solicitante = f.id WHERE " + filtroANDON + filtroFecha2 + ") UNION (SELECT 2, 'K' AS mitipo, a.id AS id2, CONCAT('K-',a.id) AS id, 0 AS estatus, a.alarmado AS alarmado_atender, '' AS alarmado_atendido, a.fecha_sugerida, a.fecha_sugerida, a.fecha_sugerida AS fechac, '" + this.servicio.rTraduccion()[8] + "' AS nlinea, IFNULL(c.nombre, '" + this.servicio.rTraduccion()[8] + "') AS nmaquina, IFNULL(d.nombre, '" + this.servicio.rTraduccion()[8] + "') AS narea, IFNULL(e.nombre, '" + this.servicio.rTraduccion()[8] + "') AS nfalla, IFNULL(f.nombre, '" + this.servicio.rTraduccion()[8] + "') AS nsolicitante FROM " + this.servicio.rBD() + ".kanban_solicitudes a LEFT JOIN " + this.servicio.rBD() + ".cat_procesos c ON a.proceso = c.id LEFT JOIN " + this.servicio.rBD() + ".cat_areas d ON a.area = d.id LEFT JOIN " + this.servicio.rBD() + ".cat_partes e ON a.parte = e.id LEFT JOIN " + this.servicio.rBD() + ".cat_usuarios f ON a.solicitante = f.id WHERE estado < 40 " + filtroFecha2 + ") ORDER BY 1, id2 LIMIT " + limite + ") AS q10 ORDER BY id2";
    let campos = {accion: 100, sentencia: sentencia};  
    this.servicio.consultasBD(campos).subscribe( resp =>
    {
